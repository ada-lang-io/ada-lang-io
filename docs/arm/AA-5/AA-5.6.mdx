...
<p class="Indented2">The <code><a href="../AA-5/AA-5.5#S0180">chunk_specification</a></code>, if any, of a <code><a href="../AA-5/AA-5.6#S0192">parallel_block_statement</a></code> shall be an <em>integer_</em><code><a href="../AA-4/AA-4.4#S0138">simple_expression</a></code>. <br /></p>
