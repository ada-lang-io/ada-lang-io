...
<strong></strong>Thus, other rules can always refer to the <code><a href="/docs/arm/AA-3/AA-3.11#S0086">declarative_part</a></code> of a <code><a href="/docs/arm/AA-5/AA-5.6#S0191">block_statement</a></code>. <br />
</Admonition>
</AnnotatedOnly>
...
<p>[A <code><a href="/docs/arm/AA-5/AA-5.6#S0192">parallel_block_statement</a></code> comprises two or more <code><a href="/docs/arm/AA-5/AA-5.1#S0166">sequence_of_statements</a></code> separated by <strong>and</strong> where each represents an independent activity that is intended to proceed concurrently with the others.]<br /></p>
