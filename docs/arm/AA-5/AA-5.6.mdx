...
<MarginInfo items={["AI12-0119-1", "AI12-0436-1"]} /><p>{"{"}<em>{"AI12-0119-1"}</em>{"}"} {"{"}<em>{"AI12-0436-1"}</em>{"}"} <br />[A <code><a href="../AA-5/AA-5.6#S0192">parallel_block_statement</a></code> comprises two or more <code><a href="../AA-5/AA-5.1#S0166">sequence_of_statements</a></code> separated by <strong>and</strong> where each represents an independent activity that is intended to proceed concurrently with the others.]<br /></p>
...
<MarginInfo items={["AI12-0429-1"]} /><p>{"{"}<em>{"AI12-0429-1"}</em>{"}"} <em><br />Example of a parallel block used to walk a binary tree in parallel:</em><br /></p>

<MarginText>7/5</MarginText>
<MarginInfo items={["AI12-0119-1", "AI12-0404-1"]} /><CodeBlock language="ada">
...
<MarginInfo items={["AI12-0429-1"]} /><p>{"{"}<em>{"AI12-0429-1"}</em>{"}"} <em><br />Example of a parallel block used to search two halves of a string in parallel:</em><br /></p>

<MarginText>9/5</MarginText>
<MarginInfo items={["AI12-0119-1"]} /><CodeBlock language="ada">
...
<MarginInfo items={["AI12-0119-1", "AI12-0427-1", "AI12-0436-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
