...
<p>{"{"}<em>{"AI12-0427-1"}</em>{"}"} The <code><a href="../AA-5/AA-5.5#S0180">chunk_specification</a></code>, if any, of a <code><a href="../AA-5/AA-5.6#S0192">parallel_block_statement</a></code> shall be an <em>integer_</em><code><a href="../AA-4/AA-4.4#S0138">simple_expression</a></code>. <br /></p>
...
<p>{"{"}<em>{"AI12-0429-1"}</em>{"}"} <em>Example of a parallel block used to search two halves of a string in parallel:</em><br /></p>
...
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI12-0119-1"}</em>{"}"} {"{"}<em>{"AI12-0427-1"}</em>{"}"} {"{"}<em>{"AI12-0436-1"}</em>{"}"} The <code><a href="../AA-5/AA-5.6#S0192">parallel_block_statement</a></code> is new. <br /></Admonition>
