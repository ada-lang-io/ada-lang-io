...
<p><strong></strong>Thus, other rules can always refer to the <code><a href="../AA-3/AA-3.11#S0086">declarative_part</a></code> of a <code><a href="../AA-5/AA-5.6#S0191">block_statement</a></code>. </p></Admonition>
