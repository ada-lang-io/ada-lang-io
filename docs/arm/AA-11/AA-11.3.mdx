...
<Admonition type="aarm" aarm="note">
<strong>Term entry: </strong><strong>raise an exception</strong> &mdash; abandon normal program execution so as to draw attention to the fact that the corresponding situation has arisen<br /></Admonition>
</AnnotatedOnly>
