...
<p>{"{"}<em>{"AI05-0299-1"}</em>{"}"} <br />[ This subclause gives permission to the implementation to perform certain &ldquo;optimizations&rdquo; that do not necessarily preserve the canonical semantics.] <br /></p>
