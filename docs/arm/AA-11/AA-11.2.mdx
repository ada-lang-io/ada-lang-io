...
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI05-0299-1"}</em>{"}"} <br />Within this clause, we sometimes abbreviate "<code><a href="../AA-11/AA-11.2#S0307">exception_choice</a></code>" to "<em>choice</em>". <br /></Admonition>


#### Legality Rules

<p>{"{"}<em>{"AI12-0022-1"}</em>{"}"} <br />An <em>exception_</em><code><a href="../AA-4/AA-4.1#S0091">name</a></code> of an <code><a href="../AA-11/AA-11.2#S0307">exception_choice</a></code> shall denote an exception.<br /></p>
