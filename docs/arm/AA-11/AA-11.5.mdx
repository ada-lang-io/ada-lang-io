...
<p>{"{"}<em>{"AI95-00224-01"}</em>{"}"} <br />An implementation may support an additional parameter on <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Unsuppress similar to the one allowed for <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Suppress (see J.10). The meaning of such a parameter is implementation-defined. <br /></p>
...
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI95-00280-01"}</em>{"}"} <br />Allocation_Check was added to support suppressing the new check on <code><a href="../AA-4/AA-4.8#S0164">allocator</a></code>s (see 4.8). <br /></Admonition>
