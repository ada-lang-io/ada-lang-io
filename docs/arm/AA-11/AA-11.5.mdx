...
<strong>Term entry: </strong><strong>suppress a check</strong> &mdash; assert that the check cannot fail, and request that the compiler optimize by disabling the check<br />Note: The compiler is not required to honor this request. Suppressing checks that can fail can cause a program to behave in arbitrary ways.<br /></Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
<strong>Term entry: </strong><strong>check</strong> &mdash; test made during execution to determine whether a language rule has been violated<br /></Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI95-00224-01"]} />
<p class="Indented2">A checking pragma is allowed only immediately within a <code><a href="../AA-3/AA-3.11#S0086">declarative_part</a></code>, immediately within a <code><a href="../AA-7/AA-7.1#S0230">package_specification</a></code>, or as a configuration pragma. <br /></p>
