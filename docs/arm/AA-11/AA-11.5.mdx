...
<MarginInfo items={["AI95-00224-01"]} />
<p class="Indented2">  <strong>pragma</strong> Suppress(<code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code>);<br /></p>

<MarginText>4.1/2</MarginText>
<MarginInfo items={["AI95-00224-01"]} />
<p class="Indented2">  <strong>pragma</strong> Unsuppress(<code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code>);<br /></p>
...
<dl>
<dd>When evaluating a dereference (explicit or implicit), check that the value of the <code><a href="/docs/arm/AA-4/AA-4.1#S0091">name</a></code> is not <strong>null</strong>. When converting to a subtype that excludes null, check that the converted value is not <strong>null</strong>.<br /></dd>
...
<Admonition type="aarm" aarm="implementation-defined">
<strong></strong>Existence and meaning of second parameter of <code><a href="/docs/arm/AA-2/AA-2.8#S0019">pragma</a></code> Unsuppress.<br />
</Admonition>
</AnnotatedOnly>
