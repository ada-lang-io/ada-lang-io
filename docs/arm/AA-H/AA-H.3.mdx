...
NOTE 1   The order of elaboration of library units will be documented even in the absence of <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Reviewable (see <a href="../AA-10/AA-10.2">10.2</a>). <br /></Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI95-00209-01"]} />
<Admonition type="aarm" aarm="note">
NOTE 1   The implementation is not allowed to perform &ldquo;dead store elimination&rdquo; on the last assignment to a variable prior to a point where the variable is inspectable. Thus an inspection point has the effect of an implicit read of each of its inspectable objects.<br /></Admonition>
</AnnotatedOnly>
