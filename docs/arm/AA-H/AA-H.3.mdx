...
<MarginInfo items={["AI95-00209-01"]} /><ul>
<li>{"{"}<em>{"AI95-00209-01"}</em>{"}"} <br />For each read of a scalar object, an identification of the read as either &ldquo;known to be initialized&rdquo;, or &ldquo;possibly uninitialized&rdquo;, independent of whether pragma Normalize_Scalars applies; <br /></li>
</ul>
...
<MarginInfo items={["AI95-00209-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00207-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00207-01"]} /><Admonition type="aarm" aarm="discussion" title="Discussion: ">
...
<MarginInfo items={["AI95-00209-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
NOTE 1   {"{"}<em>{"AI95-00209-01"}</em>{"}"} <br />The implementation is not allowed to perform &ldquo;dead store elimination&rdquo; on the last assignment to a variable prior to a point where the variable is inspectable. Thus an inspection point has the effect of an implicit read of each of its inspectable objects.<br /></Admonition>
