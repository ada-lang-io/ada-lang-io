...
<strong></strong>The information produced by <code><a href="/docs/arm/AA-2/AA-2.8#S0019">pragma</a></code> Reviewable should be provided in both a human-readable and machine-readable form, and the latter form should be documented.<br />
</Admonition>
</AnnotatedOnly>
...
<p class="Indented2">  <strong>pragma</strong> Inspection{"_"}Point[(<em>object{"_"}</em><code><a href="/docs/arm/AA-4/AA-4.1#S0091">name</a></code> {"{"}, <em>object{"_"}</em><code><a href="/docs/arm/AA-4/AA-4.1#S0091">name</a></code>{"}"})]; <br /></p>


#### Legality Rules

<MarginText>4_H.3.2</MarginText>
<p>A pragma Inspection{"_"}Point is allowed wherever a <code><a href="/docs/arm/AA-3/AA-3.11#S0087">declarative_item</a></code> or <code><a href="/docs/arm/AA-5/AA-5.1#S0167">statement</a></code> is allowed. Each <em>object{"_"}</em>name shall statically denote the declaration of an object. <br /></p>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>The compiler is inhibited from moving an assignment to an inspectable variable past an inspection point for that variable. On the other hand, the evaluation of an expression that might raise an exception may be moved past an inspection point (see <a href="/docs/arm/AA-11/AA-11.6">11.6</a>).<br />
</Admonition>
</AnnotatedOnly>
