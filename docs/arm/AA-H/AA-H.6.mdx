...
<p class="Indented2">  <strong>pragma</strong> Partition{"_"}Elaboration{"_"}Policy (<em>policy{"_"}</em><code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code>);<br /></p>

<MarginText>4/2</MarginText>
<p class="Indented2">The <em>policy{"_"}</em><code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code> shall be either Sequential, Concurrent or an implementation-defined identifier. <br /></p>

<AnnotatedOnly>
<MarginText>4.a/2</MarginText>
<Admonition type="aarm" aarm="implementation-defined">
<strong></strong>Implementation-defined <em>policy{"_"}</em><code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code>s allowed in a <code><a href="/docs/arm/AA-2/AA-2.8#S0019">pragma</a></code> Partition{"_"}Elaboration{"_"}Policy.<br />
</Admonition>
</AnnotatedOnly>
