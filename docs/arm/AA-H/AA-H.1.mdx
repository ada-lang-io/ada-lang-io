...
<MarginInfo items={["AI95-00434-01"]} />
<p>{"{"}<em>{"AI95-00434-01"}</em>{"}"} <br />Whenever possible, the implicit initial values for a scalar subtype should be an invalid representation (see <a href="../AA-13/AA-13.9#Subclause_13.9.1">13.9.1</a>). <br /></p>
