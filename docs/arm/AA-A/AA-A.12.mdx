...
<Admonition type="aarm" aarm="note">
<strong>Corrigendum:</strong> The definition of the Flush procedure was moved to <a href="/docs/arm/AA-A/AA-A.8#Subclause_A.8.2">A.8.2</a>, so that it could be shared by all of the I/O packages. <br />
</Admonition>
</AnnotatedOnly>
