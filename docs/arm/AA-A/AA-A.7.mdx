...
<strong></strong>The last sentence here is referring to the documentation requirements in <a href="/docs/arm/AA-A/AA-A.13">A.13</a>, &ldquo;<a href="/docs/arm/AA-A/AA-A.13">Exceptions in Input-Output</a>&rdquo;, and the documentation summary item is provided there. <br />
</Admonition>
</AnnotatedOnly>
