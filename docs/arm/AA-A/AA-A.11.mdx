...
<strong>To be honest: </strong>&ldquo;package Bounded&rdquo; refers to both the package Ada.Strings.Bounded and the formal package parameter named Bounded. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
<strong>Correction</strong>: Corrected the names of various entities in the above description. Since the previously named entities don't exist and the intent is obvious, this is just considered a presentation change. <br />
</Admonition>
</AnnotatedOnly>
