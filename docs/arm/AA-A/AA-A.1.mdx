...
<p>{"{"}<em>{"AI05-0299-1"}</em>{"}"} This subclause outlines the specification of the package Standard containing all predefined identifiers in the language. The corresponding package body is not specified by the language.<br /></p>
...
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI95-00285-01"}</em>{"}"} Types Wide_Wide_Character and Wide_Wide_String are new. <br /></Admonition>

<Admonition type="aarm" aarm="discussion" title="Discussion: ">
<strong></strong>The inconsistencies associated with these types are documented in 3.5.2 and 3.6.3. <br /></Admonition>

<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI95-00230-01"}</em>{"}"} Type <em>universal_access</em> and the equality operations for it are new. <br /></Admonition>


#### Wording Changes from Ada 95

<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>8652/0028</em>{"}"} {"{"}<em>{"AI95-00145-01"}</em>{"}"} <strong>Corrigendum:</strong> Corrected the parameter type for the Boolean operators declared in Standard. <br /></Admonition>


#### Wording Changes from Ada 2005

<Admonition type="aarm" aarm="correction" title="Correction:">
{"{"}<em>{"AI05-0181-1"}</em>{"}"} <strong></strong> Since soft_hyphen (position 173) is defined to be nongraphic, gave it a name. <br /></Admonition>
