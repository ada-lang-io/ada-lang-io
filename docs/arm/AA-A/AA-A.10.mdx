...
<p class="Indented4">{"{"}<em>8652/0052</em>{"}"} Returns the standard error file (see <a href="/docs/arm/AA-A/AA-A.10">A.10</a>), or an access value designating the standard error file, respectively.<br /></p>
...
<MarginInfo items={["AI12-0130-1"]} />
<Admonition type="aarm" aarm="note">
<strong>Corrigendum:</strong> Moved the definition of Flush to <a href="/docs/arm/AA-A/AA-A.8#Subclause_A.8.2">A.8.2</a>, as all input-output packages now have it. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="discussion">
<strong></strong>See also the similar permission for the Wide{"_"}Wide{"_"}Value, Wide{"_"}Value, and Value attributes in <a href="/docs/arm/AA-3/AA-3.5">3.5</a>. <br />
</Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI05-0005-1"]} />
<Admonition type="aarm" aarm="note">
<strong>To be honest: </strong>For a character type, it is permissible for the implementation to make Get do the inverse of what Put does, in the case of wide and wide{"_"}wide <code><a href="/docs/arm/AA-2/AA-2.5#S0015">character_literal</a></code>s and control characters. <br />
</Admonition>
</AnnotatedOnly>
