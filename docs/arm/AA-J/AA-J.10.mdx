...
<MarginInfo items={["AI95-00224-01"]} />
<p>The form of a specific Suppress <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> is as follows: <br /></p>
...
<Admonition type="aarm" aarm="note">
NOTE 1   An implementation can  support a similar On parameter on <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Unsuppress (see <a href="../AA-11/AA-11.5">11.5</a>). <br /></Admonition>
</AnnotatedOnly>
