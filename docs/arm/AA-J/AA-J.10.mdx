...
<p class="Indented2">  <strong>pragma</strong> Suppress(<code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code>, [On ={">"}] <code><a href="/docs/arm/AA-4/AA-4.1#S0091">name</a></code>); <br /></p>
