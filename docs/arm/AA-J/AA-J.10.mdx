...
<Admonition type="aarm" aarm="note">
NOTE   An implementation can  support a similar On parameter on <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Unsuppress (see <a href="../AA-11/AA-11.5">11.5</a>). <br /></Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
This subclause is new. This feature was moved here because it is important for pragma Unsuppress that there be an unambiguous meaning for each checking pragma. For instance, in the example <br /></Admonition>
</AnnotatedOnly>
