...
<MarginInfo items={["AI95-00224-01"]} /><p>{"{"}<em>{"AI95-00224-01"}</em>{"}"} <br />Pragma Suppress can be used to suppress checks on specific entities. <br /></p>


#### Syntax

<MarginText>2/2</MarginText>
<MarginInfo items={["AI95-00224-01"]} /><p>{"{"}<em>{"AI95-00224-01"}</em>{"}"} <br />The form of a specific Suppress <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> is as follows: <br /></p>
...
<MarginInfo items={["AI95-00224-01"]} /><p>{"{"}<em>{"AI95-00224-01"}</em>{"}"} <br />An implementation is allowed to place restrictions on specific Suppress <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code>s. <br /></p>

<MarginText>8/5</MarginText>
<MarginInfo items={["AI95-00224-01", "AI12-0440-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00224-01", "AI05-0299-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
