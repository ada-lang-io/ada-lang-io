...
<p>{"{"}<em>{"AI95-00395-01"}</em>{"}"} The following declarations exist in the declaration of package Ada.Characters.Handling:<br /></p>
...
{"{"}<em>{"AI95-00394-01"}</em>{"}"} {"{"}<em>{"AI05-0299-1"}</em>{"}"} This subclause is new. These subprograms were moved to Characters.Conversions (see A.3.4). <br /></Admonition>
