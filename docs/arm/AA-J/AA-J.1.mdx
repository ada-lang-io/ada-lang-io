...
<p><strong></strong>{"{"}<em>{"AI05-0004-1"}</em>{"}"} These library units correspond to those declared in Ada 83, which did not have the child unit concept or the parent package Ada. </p></Admonition>
