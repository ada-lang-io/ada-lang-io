...
<MarginInfo items={["AI05-0005-1", "AI95-00262-01", "AI95-00262-01", "AI05-0077-1", "AI05-0122-1", "AI12-0261-1"]} />
...
<p>{"{"}<em>{"AI05-0132-1"}</em>{"}"} {"{"}<em>{"AI12-0417-1"}</em>{"}"}  <br /></p>
...
<p>{"{"}<em>8652/0034</em>{"}"} {"{"}<em>{"AI95-00041-01"}</em>{"}"} {"{"}<em>{"AI12-0417-1"}</em>{"}"}  <br /></p>
