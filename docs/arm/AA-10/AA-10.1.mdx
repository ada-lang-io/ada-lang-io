...
<MarginInfo items={["AI95-00397-01"]} /><p>{"{"}<em>{"AI95-00397-01"}</em>{"}"} <br />An <code><a href="../AA-8/AA-8.3#S0234">overriding_indicator</a></code> is not allowed in a <code><a href="../AA-6/AA-6.1#S0195">subprogram_declaration</a></code>, <code><a href="../AA-12/AA-12.3#S0315">generic_instantiation</a></code>, or <code><a href="../AA-8/AA-8.5#S0242">subprogram_renaming_declaration</a></code> that declares a library unit.<br /></p>
...
<MarginInfo items={["AI95-00217-06"]} /><p>{"{"}<em>{"AI95-00217-06"}</em>{"}"} <br />For each library <code><a href="../AA-7/AA-7.1#S0229">package_declaration</a></code> in the environment, there is an implicit declaration of a <em>limited view</em> of that library package. The limited view of a package contains:<br /></p>

<MarginText>12.2/3</MarginText>
<MarginInfo items={["AI95-00217-06", "AI05-0129-1", "AI05-0262-1"]} /><ul>
...
<MarginInfo items={["AI05-0129-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI05-0004-1"]} /><p>{"{"}<em>{"AI05-0004-1"}</em>{"}"} <br />A child of a generic library package shall either be itself a generic unit or be a renaming of some other child of the same generic unit.<br /></p>
...
<MarginInfo items={["AI95-00217-06"]} /><p>{"{"}<em>{"AI95-00217-06"}</em>{"}"} <br />The elaboration of the declaration of the limited view of a package has no effect. <br /></p>
...
<MarginInfo items={["AI95-00331-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI05-0108-1", "AI05-0129-1"]} /><Admonition type="aarm" aarm="correction" title="Correction:">
...
<MarginInfo items={["AI95-00262-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00262-01"]} /><Admonition type="aarm" aarm="discussion" title="Discussion: ">
...
<MarginInfo items={["AI95-00262-01"]} /><p>{"{"}<em>{"AI95-00262-01"}</em>{"}"} <br />If a <code><a href="../AA-10/AA-10.1#S0294">with_clause</a></code> of a given <code><a href="../AA-10/AA-10.1#S0286">compilation_unit</a></code> mentions a private child of some library unit, then the given <code><a href="../AA-10/AA-10.1#S0286">compilation_unit</a></code> shall be one of: <br /></p>

<MarginText>9/2</MarginText>
<MarginInfo items={["AI95-00262-01"]} /><ul>
...
<MarginInfo items={["AI95-00220-01", "AI95-00262-01"]} /><li>{"{"}<em>{"AI95-00220-01"}</em>{"}"} {"{"}<em>{"AI95-00262-01"}</em>{"}"} <br />the body or subunit of a public descendant of that library unit, but not a subprogram body acting as a subprogram declaration (see <a href="../AA-10/AA-10.1#Subclause_10.1.4">10.1.4</a>); or<br /></li>
<MarginText>11/2</MarginText>
<MarginInfo items={["AI95-00262-01"]} /><li>{"{"}<em>{"AI95-00262-01"}</em>{"}"} <br />the declaration of a public descendant of that library unit, in which case the <code><a href="../AA-10/AA-10.1#S0294">with_clause</a></code> shall include the reserved word <strong>private</strong>. <br /></li>
</ul>
<MarginText>11.a/2</MarginText>
<MarginInfo items={["AI95-00262-01"]} /><Admonition type="aarm" aarm="reason" title="Reason: ">
...
<MarginInfo items={["AI95-00262-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI95-00262-01"}</em>{"}"} <br />(1) is OK because it's a private child of A.B &mdash; it would be illegal if we made A.B.X a public child of A.B. (2) is OK because it's the body of a child of A.B. (3) is OK because it's a child of A.B, and it is a private <code><a href="../AA-10/AA-10.1#S0294">with_clause</a></code>. It would be illegal to say &ldquo;<strong>with</strong> A.B.C;&rdquo; on any <code><a href="../AA-10/AA-10.1#S0287">library_item</a></code> whose name does not start with &ldquo;A.B&rdquo;. Note that mentioning A.B.C.D in a <code><a href="../AA-10/AA-10.1#S0294">with_clause</a></code> automatically mentions A.B.C as well, so &ldquo;<strong>with</strong> A.B.C.D;&rdquo; is illegal in the same places as &ldquo;<strong>with</strong> A.B.C;&rdquo;. <br /></Admonition>

<MarginText>12/5</MarginText>
<MarginInfo items={["AI05-0005-1", "AI95-00262-01", "AI95-00262-01", "AI05-0077-1", "AI05-0122-1", "AI12-0261-1"]} /><p>{"{"}<em>{"AI05-0005-1"}</em>{"}"} {"{"}<em>{"AI95-00262-01"}</em>{"}"} {"{"}<em>{"AI95-00262-01"}</em>{"}"} {"{"}<em>{"AI05-0077-1"}</em>{"}"} {"{"}<em>{"AI05-0122-1"}</em>{"}"} {"{"}<em>{"AI12-0261-1"}</em>{"}"} <br />A <code><a href="../AA-4/AA-4.1#S0091">name</a></code> denoting a <code><a href="../AA-10/AA-10.1#S0287">library_item</a></code> (or the corresponding declaration for a child of a generic within an instance &mdash; see <a href="../AA-10/AA-10.1#Subclause_10.1.1">10.1.1</a>), if it is visible only due to being mentioned in one or more <code><a href="../AA-10/AA-10.1#S0294">with_clause</a></code>s of a unit <em>U</em> that include the reserved word <strong>private</strong>, shall appear only within: <br /></p>

<MarginText>13/2</MarginText>
<ul>
<li>a private part;<br /></li>
<MarginText>14/5</MarginText>
<MarginInfo items={["AI12-0261-1"]} /><li>{"{"}<em>{"AI12-0261-1"}</em>{"}"} <br />a body of a public descendant of <em>U</em>, but not within the <code><a href="../AA-6/AA-6.1#S0196">subprogram_specification</a></code> of a  body of a subprogram that is a public descendant of <em>U</em>;<br /></li>
<MarginText>15/5</MarginText>
<MarginInfo items={["AI12-0261-1"]} /><li>{"{"}<em>{"AI12-0261-1"}</em>{"}"} <br />a private descendant of <em>U</em> or its body ; or<br /></li>
...
<MarginInfo items={["AI05-0077-1"]} /><Admonition type="aarm" aarm="reason" title="Reason: ">
...
<MarginInfo items={["AI95-00217-06"]} /><p>{"{"}<em>{"AI95-00217-06"}</em>{"}"} <br />[A <code><a href="../AA-10/AA-10.1#S0287">library_item</a></code> mentioned in a <code><a href="../AA-10/AA-10.1#S0295">limited_with_clause</a></code> shall be the implicit declaration of the limited view of a library package, not the declaration of a subprogram, generic unit, generic instance, or a renaming.]<br /></p>
...
<MarginInfo items={["AI95-00217-06", "AI95-00412-01"]} /><p>{"{"}<em>{"AI95-00217-06"}</em>{"}"} {"{"}<em>{"AI95-00412-01"}</em>{"}"} <br />A <code><a href="../AA-10/AA-10.1#S0295">limited_with_clause</a></code> shall not appear on a <code><a href="../AA-10/AA-10.1#S0290">library_unit_body</a></code>, <code><a href="../AA-10/AA-10.1#S0302">subunit</a></code>, or <code><a href="../AA-10/AA-10.1#S0289">library_unit_renaming_declaration</a></code>.<br /></p>

<MarginText>18.a/2</MarginText>
<MarginInfo items={["AI95-00412-01"]} /><Admonition type="aarm" aarm="reason" title="Reason: ">
...
<MarginText>19/2</MarginText>
<MarginInfo items={["AI95-00217-06"]} /><p>{"{"}<em>{"AI95-00217-06"}</em>{"}"} <br />A <code><a href="../AA-10/AA-10.1#S0295">limited_with_clause</a></code> that names a library package shall not appear:<br /></p>

<MarginText>20/3</MarginText>
<MarginInfo items={["AI95-00217-06", "AI05-0040-1"]} /><ul>
...
<MarginInfo items={["AI05-0040-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00217-06", "AI05-0077-1", "AI05-0262-1"]} /><ul>
...
<MarginInfo items={["AI05-0077-1"]} /><Admonition type="aarm" aarm="ramification" title="Ramification: ">
...
<MarginText>24/5</MarginText>
<MarginInfo items={["AI12-0429-1"]} /><p>{"{"}<em>{"AI12-0429-1"}</em>{"}"} <em><br />Examples of use of with clauses, limited with clauses, and private with clauses:</em> <br /></p>
...
<MarginInfo items={["AI95-00220-01"]} /><Admonition type="aarm" aarm="correction" title="Correction:">
...
<MarginInfo items={["AI95-00262-01", "AI05-0077-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI05-0040-1"]} /><Admonition type="aarm" aarm="correction" title="Correction:">
...
<MarginInfo items={["AI05-0077-1"]} /><Admonition type="aarm" aarm="correction" title="Correction:">
...
<MarginInfo items={["AI05-0122-1"]} /><Admonition type="aarm" aarm="correction" title="Correction:">
...
<MarginInfo items={["AI12-0261-1"]} /><Admonition type="aarm" aarm="correction" title="Correction:">
...
<MarginInfo items={["AI12-0429-1"]} /><p>{"{"}<em>{"AI12-0429-1"}</em>{"}"} <em><br />Example that defines package Parent without subunits:</em>  <br /></p>
...
<MarginInfo items={["AI12-0429-1", "AI12-0440-1"]} /><p>{"{"}<em>{"AI12-0429-1"}</em>{"}"} {"{"}<em>{"AI12-0440-1"}</em>{"}"} <em><br />Example showing how the body of procedure Inner can be turned into a subunit by rewriting the package body as follows (with the declaration of Parent remaining the same):</em>  <br /></p>
...
<MarginInfo items={["AI95-00243-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginText>4/3</MarginText>
<MarginInfo items={["AI95-00192-01", "AI05-0264-1"]} /><p>{"{"}<em>8652/0032</em>{"}"} {"{"}<em>{"AI95-00192-01"}</em>{"}"} {"{"}<em>{"AI05-0264-1"}</em>{"}"} <br />If a <code><a href="../AA-10/AA-10.1#S0290">library_unit_body</a></code> that is a <code><a href="../AA-6/AA-6.3#S0216">subprogram_body</a></code> is submitted to the compiler, it is interpreted only as a completion if a <code><a href="../AA-10/AA-10.1#S0288">library_unit_declaration</a></code> with the same <code><a href="../AA-6/AA-6.1#S0201">defining_program_unit_name</a></code> already exists in the environment for a subprogram other than an instance of a generic subprogram or for a generic subprogram (even if the profile of the body is not type conformant with that of the declaration); otherwise, the <code><a href="../AA-6/AA-6.3#S0216">subprogram_body</a></code> is interpreted as both the declaration and body of a library subprogram. <br /></p>
...
{"{"}<em>{"AI05-0229-1"}</em>{"}"} <br />Similarly, the implementation has to be able to compile a call to a subprogram for which aspect Inline has been specified without seeing the body of that subprogram &mdash; inlining would not be achieved in this case, but the call is still legal.<br /></Admonition>

<MarginText>5.e/3</MarginText>
<MarginInfo items={["AI95-00217-06", "AI05-0005-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00077-01", "AI95-00114-01"]} /><Admonition type="aarm" aarm="discussion" title="Discussion: ">
...
<MarginInfo items={["AI95-00214-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00077-01", "AI95-00114-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00192-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI12-0417-1"]} /><p>{"{"}<em>{"AI12-0417-1"}</em>{"}"} <br />[This subclause discusses pragmas related to  <code><a href="../AA-10/AA-10.1#S0285">compilation</a></code>s.] <br /></p>
...
<MarginInfo items={["AI95-00136-01"]} /><ul>
<li>{"{"}<em>8652/0033</em>{"}"} {"{"}<em>{"AI95-00136-01"}</em>{"}"}  <br /></li>
</ul>
...
<MarginInfo items={["AI05-0132-1", "AI12-0417-1"]} /><p>{"{"}<em>{"AI05-0132-1"}</em>{"}"} {"{"}<em>{"AI12-0417-1"}</em>{"}"}  <br /></p>
...
<MarginInfo items={["AI95-00041-01", "AI12-0417-1"]} /><p>{"{"}<em>8652/0034</em>{"}"} {"{"}<em>{"AI95-00041-01"}</em>{"}"} {"{"}<em>{"AI12-0417-1"}</em>{"}"}  <br /></p>
...
<MarginInfo items={["AI95-00136-01", "AI12-0417-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI95-00041-01", "AI12-0417-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginText>10.e/2</MarginText>
<MarginInfo items={["AI95-00212-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI05-0132-1", "AI12-0417-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI12-0417-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI12-0417-1"}</em>{"}"} <br />The terms &ldquo;program unit pragma&rdquo; and &ldquo;library unit pragma&rdquo; were moved to <a href="../AA-J/">Annex J</a>, &ldquo;<a href="../AA-J/">Obsolescent Features</a>&rdquo; (specifically to <a href="../AA-J/AA-J.15">J.15</a>) as all of the <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code>s that use these terms are now in that annex. <br /></Admonition>
...
<MarginInfo items={["AI95-00312-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
