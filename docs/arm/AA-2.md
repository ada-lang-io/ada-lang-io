...
NOTE   Every code position of ISO 10646 BMP that is not reserved for a control function is defined to be a graphic_character by this document. This includes all code positions other than 0000 - 001F, 007F - 009F, and FFFE - FFFF.
...
NOTE 1   A character_literal is an enumeration literal of a character type. See 3.5.2. 
