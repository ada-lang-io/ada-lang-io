...
<p>The facilities relevant to interfacing with the Fortran language are the package Interfaces.Fortran and support for specifying the Convention aspect with <em>convention{"_"}</em><code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code> Fortran.<br /></p>
...
<MarginInfo items={["AI05-0229-1"]} />
<p>An implementation shall support specifying aspect Convention with a Fortran <em>convention</em>{"_"}<code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code> for a Fortran-eligible type (see <a href="/docs/arm/AA-B/AA-B.1">B.1</a>). <br /></p>
