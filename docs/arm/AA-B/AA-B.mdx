...
<strong></strong>This Annex is not a &ldquo;Specialized Needs&rdquo; annex. Every implementation must support all nonoptional features defined here (mainly the package Interfaces). <br />
</Admonition>
</AnnotatedOnly>
...
<strong></strong>The intent is that the same rules apply for the optional parts of language interfacing as apply for Specialized Needs Annexes. See <a href="/docs/arm/AA-1/AA-1.1#Subclause_1.1.3">1.1.3</a> for a discussion of the purpose of these rules. <br />
</Admonition>
</AnnotatedOnly>
