...
<MarginInfo items={["AI12-0264-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
<strong>To be honest: </strong>{"{"}<em>{"AI12-0264-1"}</em>{"}"} &ldquo;<br />Shifting&rdquo; and &ldquo;rotating&rdquo; have the conventional meaning. Neither of these terms is usefully defined by the usual normative references of the Reference Manual, so we provide pseudo-code here to describe the intended semantics of the above wording (all operations in these examples are using modular semantics).<br /></Admonition>
...
<MarginInfo items={["AI95-00204-01"]} /><p><em>This paragraph was deleted.</em>{"{"}<em>{"AI95-00204-01"}</em>{"}"} <br /></p>
...
<MarginInfo items={["AI05-0299-1"]} /><p>{"{"}<em>{"AI05-0299-1"}</em>{"}"} <br />An implementation supporting an interface to C, COBOL, or Fortran should provide the corresponding package or packages described in the following subclauses. <br /></p>
...
<MarginInfo items={["AI95-00204-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
