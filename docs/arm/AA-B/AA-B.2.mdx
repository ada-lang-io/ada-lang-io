...
<strong></strong>If an interface to C, COBOL, or Fortran is provided, the corresponding package or packages described in <a href="../AA-B/">Annex B</a>, &ldquo;<a href="../AA-B/">Interface to Other Languages</a>&rdquo; should also be provided.<br />
</Admonition>
</AnnotatedOnly>
