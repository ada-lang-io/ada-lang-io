...
<p>The facilities relevant to interfacing with the COBOL language are the package Interfaces.COBOL and support for specifying the Convention aspect with <em>convention{"_"}</em><code><a href="../AA-2/AA-2.3#S0002">identifier</a></code> COBOL.<br /></p>
