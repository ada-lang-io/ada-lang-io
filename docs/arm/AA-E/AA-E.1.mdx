...
<p>An <em>active partition</em> is a partition as defined in <a href="/docs/arm/AA-10/AA-10.2">10.2</a>. A <em>passive partition</em> is a partition that has no thread of control of its own, whose library units are all preelaborated, and whose data and subprograms are accessible to one or more active partitions. <br /></p>
