...
<MarginInfo items={["AI12-0359-1"]} /><Admonition type="aarm" aarm="ramification" title="Ramification: ">
...
<MarginInfo items={["AI95-00226-01"]} /><p>{"{"}<em>{"AI95-00226-01"}</em>{"}"} <br />It is a bounded error for there to be cyclic elaboration dependences between the active partitions of a single distributed program. The possible effects, in each of the partitions involved, are deadlock during elaboration, or the raising of Communication_Error or Program_Error. <br /></p>
...
<MarginInfo items={["AI95-00226-01"]} /><Admonition type="aarm" aarm="note" title="Note: ">
