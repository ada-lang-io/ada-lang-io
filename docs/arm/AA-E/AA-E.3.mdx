...
The rules guarantee that remote call interface and shared passive library units are consistent among all partitions prior to the execution of a distributed program, so that the semantics of the distributed program are well defined.<br /></Admonition>
...
<MarginInfo items={["AI95-00104-01"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>8652/0084</em>{"}"} <strong>Corrigendum:</strong> Clarified the meaning of 'Version and 'Body_Version. <br /></Admonition>
