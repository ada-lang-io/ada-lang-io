...
<Admonition type="aarm" aarm="discussion">
<strong></strong>The use of the term <em>stub</em> in this annex should not be confused with <code><a href="/docs/arm/AA-10/AA-10.1#S0297">body_stub</a></code> as defined in <a href="/docs/arm/AA-10/AA-10.1#Subclause_10.1.3">10.1.3</a>. The term <em>stub</em> is used here because it is a commonly understood term when talking about the RPC paradigm. <br />
</Admonition>
</AnnotatedOnly>
