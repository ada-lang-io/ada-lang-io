...
<Admonition type="aarm" aarm="implementation-note">
<strong></strong>An implementation could also dynamically allocate more space as needed, only propagating Storage{"_"}Error if the <code><a href="../AA-4/AA-4.8#S0164">allocator</a></code> it calls raises Storage{"_"}Error. This storage could be managed through a controlled component of the stream object, to ensure that it is reclaimed when the stream object is finalized. <br />
</Admonition>
</AnnotatedOnly>
