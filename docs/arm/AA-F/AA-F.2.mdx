...
<p><strong></strong>The values of named numbers in the package Decimal.</p></Admonition>
...
<p><strong></strong>The name is Max_Decimal_Digits versus Max_Digits, in order to avoid confusion with the named number System.Max_Digits relevant to floating point. </p></Admonition>
