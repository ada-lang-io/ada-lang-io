...
<MarginInfo items={["AI05-0241-1"]} />
<p>{"{"}<em>{"AI05-0241-1"}</em>{"}"} <br />The <code><a href="../AA-13/AA-13.12#S0360">restriction_parameter_argument</a></code> of a No_Specification_of_Aspect restriction shall be an <code><a href="../AA-2/AA-2.3#S0002">identifier</a></code>; this is an identifier specific to a pragma (see <a href="../AA-2/AA-2.8">2.8</a>) and does not denote any declaration.<br /></p>
