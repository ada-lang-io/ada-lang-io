...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>The expected type for X'Unchecked_Access is as for X'Access.</p></Admonition>
