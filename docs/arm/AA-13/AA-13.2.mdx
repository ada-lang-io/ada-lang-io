...
<strong></strong>The only high level semantic effect of specifying the Pack aspect is potential loss of independent addressability (see <a href="/docs/arm/AA-9/AA-9.10">9.10</a>, &ldquo;<a href="/docs/arm/AA-9/AA-9.10">Shared Variables</a>&rdquo;).] <br />
</Admonition>
</AnnotatedOnly>
