...
<dd>The smallest delta allowed in an <code><a href="/docs/arm/AA-3/AA-3.5#S0048">ordinary_fixed_point_definition</a></code> that has the <code><a href="/docs/arm/AA-3/AA-3.5#S0046">real{"_"}range{"_"}specification</a></code> <strong>range</strong> &ndash;1.0 .. 1.0. ]<br /></dd>
