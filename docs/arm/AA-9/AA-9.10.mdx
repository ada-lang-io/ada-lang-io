...
<li>{"{"}<em>8652/0031</em>{"}"} If A1 is the termination of a task T, and A2 is either an evaluation of the expression T'Terminated that results in True, or a call to Ada.Task{"_"}Identification.Is{"_"}Terminated with an actual parameter that identifies T and a result of True (see <a href="/docs/arm/AA-C/AA-C.7#Subclause_C.7.1">C.7.1</a>);<br /></li>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>Evaluating the <code><a href="/docs/arm/AA-9/AA-9.5#S0259">entry_index</a></code> of an <code><a href="/docs/arm/AA-9/AA-9.5#S0258">accept_statement</a></code> is not synchronized with a corresponding entry call, nor is evaluating the entry barrier of an <code><a href="/docs/arm/AA-9/AA-9.5#S0260">entry_body</a></code>. <br />
</Admonition>
</AnnotatedOnly>
...
<p class="Indented2">  <strong>pragma</strong> Conflict{"_"}Check{"_"}Policy (<em>policy{"_"}</em><code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code>[, <em>policy{"_"}</em><code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code>]);<br /></p>
