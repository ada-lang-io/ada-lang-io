...
<strong></strong>The master of a task created by a return statement changes when the accessibility of the return object changes. Note that its activation happens, if at all, only after the function returns and all accessibility level changes have occurred. <br />
</Admonition>
</AnnotatedOnly>
...
<strong></strong>Don't confuse these kinds of dependences with the dependences among compilation units defined in <a href="../AA-10/AA-10.1#Subclause_10.1.1">10.1.1</a>, &ldquo;<a href="../AA-10/AA-10.1#Subclause_10.1.1">Compilation Units - Library Units</a>&rdquo;. <br />
</Admonition>
</AnnotatedOnly>
...
<p>Completion of a task (and the corresponding <code><a href="../AA-9/AA-9.1#S0248">task_body</a></code>) can occur when the task is blocked at a <code><a href="../AA-9/AA-9.7#S0269">select{"_"}statement</a></code> with an open <code><a href="../AA-9/AA-9.7#S0275">terminate_alternative</a></code> (see <a href="../AA-9/AA-9.7#Subclause_9.7.1">9.7.1</a>); the open <code><a href="../AA-9/AA-9.7#S0275">terminate_alternative</a></code> is selected if and only if the following conditions are satisfied: <br /></p>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>Any required finalization is performed after the selection of <code><a href="../AA-9/AA-9.7#S0275">terminate_alternative</a></code>s. The tasks are not callable during the finalization. In some ways it is as though they were aborted. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
NOTE 2   An <code><a href="../AA-8/AA-8.5#S0239">object_renaming_declaration</a></code> defines a new view of an existing entity and hence creates no further dependence.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
NOTE 4   If two or more tasks are blocked on <code><a href="../AA-9/AA-9.7#S0269">select_statement</a></code>s with open <code><a href="../AA-9/AA-9.7#S0275">terminate_alternative</a></code>s, and become completed collectively, their finalization actions proceed concurrently.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
We have revised the wording to be consistent with the definition of master now given in <a href="../AA-7/AA-7.6#Subclause_7.6.1">7.6.1</a>, &ldquo;<a href="../AA-7/AA-7.6#Subclause_7.6.1">Completion and Finalization</a>&rdquo;.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
What was "collective termination" is now "collective completion" resulting from selecting <code><a href="../AA-9/AA-9.7#S0275">terminate_alternative</a></code>s. This is because finalization still occurs for such tasks, and this happens after selecting the <code><a href="../AA-9/AA-9.7#S0275">terminate_alternative</a></code>, but before termination. <br />
</Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI95-00416-01"]} />
<Admonition type="aarm" aarm="note">
Added missing wording that explained the master of tasks that are neither <code><a href="../AA-3/AA-3.3#S0032">object_declaration</a></code>s nor <code><a href="../AA-4/AA-4.8#S0164">allocator</a></code>s, such as function returns. <br />
</Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI12-0070-1"]} />
<Admonition type="aarm" aarm="note">
<strong>Corrigendum:</strong> Ensured that the master of tasks that are not <code><a href="../AA-4/AA-4.8#S0164">allocator</a></code>s of named access types is correctly determined. (Ignoring the accessibility rules of <a href="../AA-3/AA-3.10#Subclause_3.10.2">3.10.2</a> could not be intended.) <br />
</Admonition>
</AnnotatedOnly>
