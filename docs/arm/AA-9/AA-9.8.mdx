...
<MarginInfo items={["AI12-0444-1"]} /><p>{"{"}<em>{"AI12-0444-1"}</em>{"}"} <br />Each <em>task_</em><code><a href="../AA-4/AA-4.1#S0091">name</a></code> is expected to be of any task type[; each can be of a different  task type.]<br /></p>
...
<MarginInfo items={["AI12-0119-1"]} /><li>{"{"}<em>{"AI12-0119-1"}</em>{"}"} <br />a point within a parallel construct where a new logical thread of control is created;<br /></li>
<MarginText>17.2/5</MarginText>
<MarginInfo items={["AI12-0119-1"]} /><li>{"{"}<em>{"AI12-0119-1"}</em>{"}"} <br />the end of a parallel construct;<br /></li>
