...
<strong>To be honest: </strong>The execution of an Ada program consists of the execution of one or more partitions (see <a href="../AA-10/AA-10.2">10.2</a>), each of which in turn consists of the execution of an environment task and zero or more subtasks. <br />
</Admonition>
</AnnotatedOnly>
