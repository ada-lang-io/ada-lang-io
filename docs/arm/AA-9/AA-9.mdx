...
<MarginInfo items={["AI05-0299-1", "AI12-0119-1", "AI12-0330-1"]} /><p>{"{"}<em>{"AI05-0299-1"}</em>{"}"} {"{"}<em>{"AI12-0119-1"}</em>{"}"} {"{"}<em>{"AI12-0330-1"}</em>{"}"} <br />The execution of an Ada program consists of the execution of one or more <em>tasks</em>. Each task represents a separable activity  that proceeds independently and concurrently between the points where it <em>interacts</em> with other tasks. A single task, when within the context of a parallel construct, can represent multiple <em>logical threads of control</em> which can proceed in parallel; in other contexts, each task represents one logical thread of control.  <br /></p>
...
<MarginInfo items={["AI12-0119-1"]} /><ul>
...
<MarginInfo items={["AI12-0119-1", "AI12-0440-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
