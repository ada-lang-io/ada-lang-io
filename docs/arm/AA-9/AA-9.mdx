...
<p><strong></strong>A logical thread of control is an activity within the execution of a program that can proceed in parallel with other activities of the same task, or of separate tasks.</p></Admonition>
