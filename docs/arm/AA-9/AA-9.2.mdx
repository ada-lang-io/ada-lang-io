...
<strong>To be honest: </strong>{"{"}<em>{"AI95-00265-01"}</em>{"}"} <br />The pragma Partition_Elaboration_Policy (see H.6) can be used to defer task activation to a later point, thus changing many of these rules. <br /></Admonition>
...
<Admonition type="aarm" aarm="note" title="Note: ">
NOTE 3   A task can become completed during its activation either because of an exception or because it is aborted (see 9.8).<br /></Admonition>
