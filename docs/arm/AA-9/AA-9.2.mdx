...
<strong></strong>If Tasking{"_"}Error is raised, it can be handled by handlers of the <code><a href="/docs/arm/AA-11/AA-11.2#S0304">handled{"_"}sequence{"_"}of{"_"}statements</a></code>. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>Note that a task created by an <code><a href="/docs/arm/AA-4/AA-4.8#S0164">allocator</a></code> does not necessarily depend on its activator; in such a case the activator's termination can precede the termination of the newly created task. <br />
</Admonition>
</AnnotatedOnly>
...
<strong>To be honest: </strong>The pragma Partition{"_"}Elaboration{"_"}Policy (see <a href="/docs/arm/AA-H/AA-H.6">H.6</a>) can be used to defer task activation to a later point, thus changing many of these rules. <br />
</Admonition>
</AnnotatedOnly>
