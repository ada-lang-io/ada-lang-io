...
<p><strong></strong>An <em>index</em> is a discrete quantity used to select along a given dimension of an array. A component is selected by specifying corresponding values for each of the indices. </p></Admonition>
...
<p><strong></strong>This applies to all uses of <code><a href="../AA-3/AA-3.6#S0056">component_definition</a></code>, including in <code><a href="../AA-3/AA-3.8#S0066">record_type_definition</a></code>s and <code><a href="../AA-9/AA-9.4#S0251">protected_definition</a></code>s.</p></Admonition>
...
<Admonition type="aarm" aarm="discussion" title="Discussion: ">
<p><strong></strong>{"{"}<em>{"AI05-0005-1"}</em>{"}"} Although there is no nameable unconstrained array subtype in this case, the predefined slicing and concatenation operations can operate on and yield values that do not necessarily belong to the first array subtype. This is also true for Ada 83. </p></Admonition>
...
<p><strong></strong>This ensures that indexing over the discrete subtype can be performed with regular Integers, rather than only <em>universal_integer</em>s. </p></Admonition>

<Admonition type="aarm" aarm="discussion" title="Discussion: ">
<p><strong></strong>We considered doing this by simply creating a "preference" for Integer when resolving the <code><a href="../AA-3/AA-3.5#S0037">range</a></code>. However, this can introduce <em>Beaujolais</em> effects when the <code><a href="../AA-4/AA-4.4#S0138">simple_expression</a></code>s involve calls on functions visible due to <strong>use</strong> clauses. </p></Admonition>
...
<Admonition type="aarm" aarm="discussion" title="Discussion: ">
<p><strong></strong>In Ada 95, <code><a href="../AA-3/AA-3.6#S0057">index_constraint</a></code>s only appear in a <code><a href="../AA-3/AA-3.2#S0027">subtype_indication</a></code>; they no longer appear in <code><a href="../AA-3/AA-3.6#S0054">constrained_array_definition</a></code>s. </p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>There is no need to define compatibility with a constrained array subtype, because one is not allowed to constrain it again.</p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>These attributes are not defined if A is a subtype-mark for an access-to-array subtype. They are defined (by implicit dereference) for access-to-array values.</p></Admonition>
...
<p><strong></strong>Multidimensional arrays should be represented in row-major order, unless the array has convention Fortran.</p></Admonition>
