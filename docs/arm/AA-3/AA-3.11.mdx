...
<CodeBlock>
{"{"}<em>8652/0009</em>{"}"} <code>basic_declarative_item</code><a id="S0088"></a><code> ::= </code><br />    <code><a href="../AA-3/AA-3.1#S0021">basic_declaration</a></code> | <code><a href="../AA-13/AA-13.1#S0343">aspect_clause</a></code> | <code><a href="../AA-8/AA-8.4#S0235">use_clause</a></code><br />
...
<Admonition type="aarm" aarm="note" title="Note: ">
The syntax for <code><a href="../AA-3/AA-3.11#S0086">declarative_part</a></code> is modified to remove the ordering restrictions of Ada 83; that is, the distinction between <code><a href="../AA-3/AA-3.11#S0088">basic_declarative_item</a></code>s and <code>later_declarative_item</code>s within <code><a href="../AA-3/AA-3.11#S0086">declarative_part</a></code>s is removed. This means that things like <code><a href="../AA-8/AA-8.4#S0235">use_clause</a></code>s and <code><a href="../AA-3/AA-3.3#S0032">object_declaration</a></code>s can be freely intermixed with things like bodies.<br /></Admonition>
...
<MarginInfo items={["AI95-00064-01"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>8652/0014</em>{"}"} <strong>Corrigendum:</strong> Clarified that the elaboration check applies to all kinds of subprogram bodies.<br /></Admonition>

<MarginText>14.h/2</MarginText>
<MarginInfo items={["AI95-00420-01"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
Defined &ldquo;declaration list&rdquo; to avoid confusion for various rules. Other kinds of declaration list are defined elsewhere. <br /></Admonition>
...
<Admonition type="aarm" aarm="note" title="Note: ">
An incomplete type (whether declared in the limited view of a package or not) may be completed by a private type declaration, so we can in fact have <em>four</em> parts.<br /></Admonition>
...
<MarginInfo items={["AI05-0229-1"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
NOTE 1   Completions are in principle allowed for any kind of explicit declaration. However, for some kinds of declaration, the only allowed completion is an implementation-defined pragma, and implementations are not required to have any such pragmas. <br /></Admonition>
...
<MarginInfo items={["AI95-00064-01"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>8652/0014</em>{"}"} <strong>Corrigendum:</strong> Added a definition of <em>body</em>, which is different than <code><a href="../AA-3/AA-3.11#S0089">body</a></code> or <strong>body</strong>. <br /></Admonition>
...
<Admonition type="aarm" aarm="note" title="Note: ">
Added null procedures and expression functions that are completions to the definition of <em>body</em>. <br /></Admonition>
