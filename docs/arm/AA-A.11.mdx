...
<p><strong>To be honest: </strong>{"{"}<em>{"AI05-0005-1"}</em>{"}"} "package Bounded" refers to both the package Ada.Strings.Bounded and the formal package parameter named Bounded. </p>
...
<p>Support for Wide_Character and Wide_String I/O is new in Ada 95. </p>

#### Extensions to Ada 95

<p>{"{"}<em>{"AI95-00285-01"}</em>{"}"} Package Wide_Wide_Text_IO is new. Be glad it wasn't called Double_Wide_Text_IO (for use in trailer parks) or Really_Wide_Text_IO.</p>
<p>{"{"}<em>{"AI95-00301-01"}</em>{"}"} Packages Wide_Text_IO.Wide_Unbounded_IO and Wide_Wide_Text_IO.Wide_Wide_Unbounded_IO are also new.</p>
<p>{"{"}<em>{"AI95-00428-01"}</em>{"}"} Packages Wide_Text_IO.Wide_Bounded_IO and Wide_Wide_Text_IO.Wide_Wide_Bounded_IO are new as well. </p>

#### Wording Changes from Ada 2005

<p>{"{"}<em>{"AI05-0092-1"}</em>{"}"} <strong>Correction</strong>: Corrected the names of various entities in the above description. Since the previously named entities don't exist and the intent is obvious, this is just considered a presentation change. </p>
