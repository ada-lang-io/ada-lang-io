...
<p>Each use of a unary or binary operator is equivalent to a <code><a href="../AA-6/AA-6.4#S0218">function_call</a></code> with <em>function{"_"}</em><code><a href="../AA-4/AA-4.1#S0093">prefix</a></code> being the corresponding <code><a href="../AA-6/AA-6.1#S0202">operator_symbol</a></code>, and with (respectively) one or two positional actual parameters being the operand(s) of the operator (in order). <br /></p>

<AnnotatedOnly>
<MarginText>2.a/5</MarginText>
<MarginInfo items={["AI05-0299-1", "AI12-0449-1"]} />
<Admonition type="aarm" aarm="note">
<strong>To be honest: </strong>We also use the term operator (in Clause <a href="../AA-4/">4</a> and in <a href="../AA-6/AA-6.1">6.1</a>) to refer to one of the syntactic categories defined in <a href="../AA-4/AA-4.5">4.5</a>, &ldquo;<a href="../AA-4/AA-4.5">Operators and Expression Evaluation</a>&rdquo; whose names end with &ldquo;{"_"}operator:&rdquo; <code><a href="../AA-4/AA-4.5#S0142">logical{"_"}operator</a></code>, <code><a href="../AA-4/AA-4.5#S0143">relational{"_"}operator</a></code>, <code><a href="../AA-4/AA-4.5#S0144">binary{"_"}adding{"_"}operator</a></code>, <code><a href="../AA-4/AA-4.5#S0145">unary{"_"}adding{"_"}operator</a></code>, <code><a href="../AA-4/AA-4.5#S0146">multiplying{"_"}operator</a></code>, and <code><a href="../AA-4/AA-4.5#S0147">highest{"_"}precedence{"_"}operator</a></code>. <br />
</Admonition>
</AnnotatedOnly>
