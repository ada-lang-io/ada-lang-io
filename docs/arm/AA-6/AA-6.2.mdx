...
<Admonition type="aarm" aarm="note" title="Note: ">
<a href="../AA-C/AA-C.6">C.6</a>, "<a href="../AA-C/AA-C.6">Shared Variable Control</a>" says that a composite type with an atomic or volatile subcomponent is a by-reference type, among other things.<br /></Admonition>
...
<Admonition type="aarm" aarm="note" title="Note: ">
Discussion of copy-in for parts of out parameters is now covered in <a href="../AA-6/AA-6.4#Subclause_6.4.1">6.4.1</a>, "<a href="../AA-6/AA-6.4#Subclause_6.4.1">Parameter Associations</a>".<br /></Admonition>
