...
<li>{"{"}<em>{"AI95-00252-01"}</em>{"}"} {"{"}<em>{"AI95-00407-01"}</em>{"}"} {"{"}<em>{"AI12-0107-1"}</em>{"}"} <br />any prefixed view of a subprogram (see <a href="../AA-4/AA-4.1#Subclause_4.1.3">4.1.3</a>) without synchronization kind (see <a href="../AA-9/AA-9.5">9.5</a>) By_Entry or By_Protected_Procedure. <br /></li>
<AnnotatedOnly>
<MarginText>
10.a/5
</MarginText>
...
<Admonition type="aarm" aarm="discussion" title="Discussion: ">
<strong></strong>This definition is used in <a href="../AA-9/AA-9.5#Subclause_9.5.2">9.5.2</a>, "<a href="../AA-9/AA-9.5#Subclause_9.5.2">Entries and Accept Statements</a>" for the conformance required between the <code><a href="../AA-3/AA-3.6#S0055">discrete_subtype_definition</a></code>s of an <code><a href="../AA-9/AA-9.5#S0257">entry_declaration</a></code> for a family of entries and the corresponding <code><a href="../AA-9/AA-9.5#S0263">entry_index_specification</a></code> of the <code><a href="../AA-9/AA-9.5#S0260">entry_body</a></code>. <br /></Admonition>
...
<p><em>Paragraphs 2 through 4 were moved to <a href="../AA-J/">Annex J</a>, "<a href="../AA-J/">Obsolescent Features</a>".</em> <br /></p>
