...
<p><strong></strong>See 12.2 for elaboration of a generic body. Note that protected <code>subprogram_bodies</code> never get elaborated; the elaboration of the containing <code><a href="../AA-9/AA-9.4#S0254">protected_body</a></code> allows them to be called without failing the Elaboration_Check. </p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>See also the rule about renamings-as-body in 8.5.4. </p></Admonition>
...
<p><strong></strong>Consider: </p></Admonition>
...
<Admonition type="aarm" aarm="reason" title="Reason: ">
<p><strong></strong>{"{"}<em>{"AI12-0005-1"}</em>{"}"} The profile of a prefixed view is different from the "real" profile of the subprogram (it doesn't have the first parameter), so we don't want to be able to take 'Access of it, as that would require generating a wrapper of some sort.</p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>The calling convention for other anonymous access-to-subprogram types is Ada. </p></Admonition>
...
<Admonition type="aarm" aarm="reason" title="Reason: ">
<p><strong></strong>The first rule is officially stated in 3.9.2. The second is intended to make interfacing to foreign OOP languages easier, by making the default be that the type and operations all have the same convention. </p></Admonition>
...
<p><strong></strong>{"{"}<em>{"AI05-0229-1"}</em>{"}"} The names of the <em>protected</em> and <em>entry</em> calling conventions cannot be used in the specification of Convention. Note that <strong>protected</strong> and <strong>entry</strong> are reserved words. </p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>Full conformance requires subtype conformance, which requires the same calling conventions. However, the calling convention of the declaration and body of a subprogram or entry are always the same by definition. </p></Admonition>

<Admonition type="aarm" aarm="reason" title="Reason: ">
<p><strong></strong>{"{"}<em>{"AI05-0046-1"}</em>{"}"} The part about <code><a href="../AA-3/AA-3.10#S0083">null_exclusion</a></code>s is necessary to prevent controlling parameters from having different exclusions, as such a parameter is defined to exclude null whether or not an exclusion is given.</p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>{"{"}<em>{"AI12-0342-1"}</em>{"}"} This rule applies to <code><a href="../AA-2/AA-2.5#S0015">character_literal</a></code>s, so even though other rules would allow a rename of a character literal to conform to the literal, this rule prevents that. </p></Admonition>

<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>Note that the above definition makes full conformance a transitive relation. </p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>In the <code><a href="../AA-3/AA-3.2#S0027">subtype_indication</a></code> case, any ranges have to <em>be</em> corresponding; that is, two <code><a href="../AA-3/AA-3.2#S0027">subtype_indication</a></code>s cannot conform unless both or neither has a <code><a href="../AA-3/AA-3.5#S0037">range</a></code>. </p></Admonition>

<Admonition type="aarm" aarm="discussion" title="Discussion: ">
<p><strong></strong>This definition is used in 9.5.2, "Entries and Accept Statements" for the conformance required between the <code><a href="../AA-3/AA-3.6#S0055">discrete_subtype_definition</a></code>s of an <code><a href="../AA-9/AA-9.5#S0257">entry_declaration</a></code> for a family of entries and the corresponding <code><a href="../AA-9/AA-9.5#S0263">entry_index_specification</a></code> of the <code><a href="../AA-9/AA-9.5#S0260">entry_body</a></code>. </p></Admonition>
...
<Admonition type="aarm" aarm="discussion" title="Discussion: ">
<p><strong></strong>This definition is used to define how primitive subprograms of interfaces match operations in task and protected type definitions (see 9.1 and 9.4). </p></Admonition>

<Admonition type="aarm" aarm="reason" title="Reason: ">
<p><strong></strong>The weird rule about conventions is pretty much required for synchronized interfaces to make any sense. There will be wrappers all over the place for interfaces anyway. Of course, this doesn't imply that entries have the same convention as protected operations. </p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>{"{"}<em>{"AI05-0229-1"}</em>{"}"} The meaning of a subprogram can be changed by inline expansion as requested by aspect Inline only in the presence of failing checks (see 11.6). </p></Admonition>
