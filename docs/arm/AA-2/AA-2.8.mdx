...
<Admonition type="aarm" aarm="note">
<strong>To be honest: </strong>For compatibility with Ada 83, the name of a <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> may also be &ldquo;<strong>interface</strong>&rdquo;, which is not an identifier (because it is a reserved word). See <a href="../AA-J/AA-J.12">J.12</a>. <br /></Admonition>
</AnnotatedOnly>
...
<strong></strong> Allow <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code>s in place of a <code><a href="../AA-5/AA-5.1#S0167">statement</a></code>, even if there are no other <code><a href="../AA-5/AA-5.1#S0167">statement</a></code>s in a <code><a href="../AA-5/AA-5.1#S0166">sequence_of_statements</a></code>.<br /></Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI05-0272-1"]} />
<Admonition type="aarm" aarm="note">
Identifiers specific to a pragma can be reserved words.<br /></Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI05-0290-1"]} />
<Admonition type="aarm" aarm="note">
Pragma arguments can be identified with <code><a href="../AA-13/AA-13.1#S0347">aspect_mark</a></code>s; this allows <code><a href="../AA-2/AA-2.3#S0002">identifier</a></code>'Class in this context. As usual, this is only allowed if specifically allowed by a particular pragma. <br /></Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI05-0100-1"]} />
<Admonition type="aarm" aarm="correction">
<strong></strong> Clarified where <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code>s are (and are not) allowed. <br /></Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
Updated the example of named pragma parameters, because the second parameter of <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Suppress is obsolescent. <br /></Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI05-0229-1"]} />
<Admonition type="aarm" aarm="note">
Updated the example of pragmas, because both <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code>s Inline and Import are obsolescent. <br /></Admonition>
</AnnotatedOnly>
