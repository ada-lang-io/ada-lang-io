...
<MarginInfo items={["AI05-0100-1", "AI05-0163-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI12-0236-1"]} /><ul>
...
<MarginInfo items={["AI05-0272-1"]} /><p>{"{"}<em>{"AI05-0272-1"}</em>{"}"} <br />An <em>identifier specific to a pragma</em> is an identifier or reserved word that is used in a pragma argument with special meaning for that pragma. <br /></p>
...
<MarginInfo items={["AI05-0163-1"]} /><Admonition type="aarm" aarm="correction" title="Correction:">
...
<MarginInfo items={["AI05-0100-1"]} /><Admonition type="aarm" aarm="correction" title="Correction:">
...
<MarginInfo items={["AI95-00433-01", "AI05-0229-1", "AI12-0417-1"]} /><CodeBlock language="ada">
