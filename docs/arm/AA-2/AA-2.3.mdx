...
<p>An <code><a href="../AA-2/AA-2.3#S0002">identifier</a></code> shall not contain two consecutive characters in category <code>punctuation_connector</code>, or end with a character in that category. <br /></p>
...
<MarginInfo items={["AI12-0004-1", "AI12-0263-1"]} />
<p>An identifier shall only contain characters that may be present in Normalization Form KC (as defined by Clause 21 of ISO/IEC 10646:2017).<br /></p>
...
<MarginInfo items={["AI95-00285-01", "AI05-0091-1", "AI05-0227-1", "AI05-0266-1", "AI05-0299-1", "AI12-0263-1"]} />
<p>Two <code><a href="../AA-2/AA-2.3#S0002">identifier</a></code>s are considered the same if they consist of the same sequence of characters after applying locale-independent simple case folding, as defined by documents referenced  in Clause 2  of ISO/IEC 10646:2017 . <br /></p>
...
<Admonition type="aarm" aarm="note">
NOTE 1   <code><a href="../AA-2/AA-2.3#S0002">Identifier</a></code>s differing only in the use of corresponding upper and lower case letters are considered the same. <br /></Admonition>
</AnnotatedOnly>
