...
<Admonition type="aarm" aarm="ramification">
<strong></strong>Because syntax rules are relevant to overload resolution, it means that if it looks like a reserved word, it is not an <code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code>. As a side effect, implementations cannot use reserved words as implementation-defined attributes or pragma names. <br />
</Admonition>
</AnnotatedOnly>
