...
<Admonition type="aarm" aarm="reason">
<strong></strong>Clause <a href="/docs/arm/AA-10/">10</a> defines only a partial ordering of <code><a href="/docs/arm/AA-10/AA-10.1#S0287">library_item</a></code>s. Therefore, it is a good idea to restrict the immediate scope (and the scope, defined below) to semantic dependents.<br />
</Admonition>
</AnnotatedOnly>
...
<strong></strong>This rule applies to limited views as well as &ldquo;normal&rdquo; library items. In that case, the semantic dependents are the units that have a <code><a href="/docs/arm/AA-10/AA-10.1#S0295">limited_with_clause</a></code> for the limited view. <br />
</Admonition>
</AnnotatedOnly>
...
<ul>
<li>[The visible part of a package, task unit, or protected unit consists of declarations in the program unit's declaration other than those following the reserved word <strong>private</strong>, if any; see <a href="/docs/arm/AA-7/AA-7.1">7.1</a> and <a href="/docs/arm/AA-12/AA-12.7">12.7</a> for packages, <a href="/docs/arm/AA-9/AA-9.1">9.1</a> for task units, and <a href="/docs/arm/AA-9/AA-9.4">9.4</a> for protected units.] <br /></li>
</ul>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>There are some obscure cases involving generics in which there is no such notation. See Clause <a href="/docs/arm/AA-12/">12</a>. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
The scope of an <code><a href="/docs/arm/AA-13/AA-13.3#S0349">attribute_definition_clause</a></code> is defined so that it can be used to define the visibility of such a clause, so <em>that</em> can be used by the stream attribute availability rules (see <a href="/docs/arm/AA-13/AA-13.13#Subclause_13.13.2">13.13.2</a>). <br />
</Admonition>
</AnnotatedOnly>
