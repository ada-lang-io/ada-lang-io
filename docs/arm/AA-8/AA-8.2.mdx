...
<Admonition type="aarm" aarm="reason">
<strong></strong>Clause <a href="../AA-10/">10</a> defines only a partial ordering of <code><a href="../AA-10/AA-10.1#S0287">library_item</a></code>s. Therefore, it is a good idea to restrict the immediate scope (and the scope, defined below) to semantic dependents.<br />
</Admonition>
</AnnotatedOnly>
...
<strong></strong>This rule applies to limited views as well as &ldquo;normal&rdquo; library items. In that case, the semantic dependents are the units that have a <code><a href="../AA-10/AA-10.1#S0295">limited_with_clause</a></code> for the limited view. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>In other words, a declaration in the private part can be visible within the visible part, private part and body of a private child unit. On the other hand, such a declaration can be visible within only the private part and body of a public child unit. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="reason">
<strong></strong>The purpose of this rule is to prevent children from giving private information to clients. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>For a public child subprogram, this means that the parent's private part is not visible in the profile of the declaration and of the body. This is true even for <code>subprogram{"_"}bodies</code> that are not completions. For a public child generic unit, it means that the parent's private part is not visible in the <code><a href="../AA-12/AA-12.1#S0313">generic_formal_part</a></code>, as well as in the first list of <code><a href="../AA-3/AA-3.11#S0088">basic_declarative_item</a></code>s (for a generic package), or the (syntactic) profile (for a generic subprogram). <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>The visible part of an instance of a generic unit is as defined for packages and subprograms; it is not defined in terms of the visible part of a generic unit. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>The rule for immediate scope implies the following: <br />
</Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI05-0299-1"]} />
<Admonition type="aarm" aarm="note">
NOTE   There are notations for denoting visible declarations that are not directly visible. For example, <code><a href="../AA-6/AA-6.1#S0207">parameter{"_"}specification</a></code>s are in the visible part of a <code><a href="../AA-6/AA-6.1#S0195">subprogram{"_"}declaration</a></code> so that they can be used in named-notation calls appearing outside the called subprogram. For another example, declarations of the visible part of a package can be denoted by expanded names appearing outside the package, and can be made directly visible by a <code><a href="../AA-8/AA-8.4#S0235">use_clause</a></code>. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>There are some obscure cases involving generics in which there is no such notation. See Clause <a href="../AA-12/">12</a>. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
We no longer need to talk about the scope of notations, <code><a href="../AA-2/AA-2.3#S0002">identifier</a></code>s, <code><a href="../AA-2/AA-2.5#S0015">character_literal</a></code>s, and <code><a href="../AA-6/AA-6.1#S0202">operator_symbol</a></code>s.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
In Ada 83, the semantics of <code><a href="../AA-10/AA-10.1#S0294">with_clause</a></code>s was described in terms of visibility. It is now described in terms of [immediate] scope.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
even though Q is declared in the declarative region of Standard, because R does not mention Q in a <code><a href="../AA-10/AA-10.1#S0294">with_clause</a></code>. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
The scope of an <code><a href="../AA-13/AA-13.3#S0349">attribute_definition_clause</a></code> is defined so that it can be used to define the visibility of such a clause, so <em>that</em> can be used by the stream attribute availability rules (see <a href="../AA-13/AA-13.13#Subclause_13.13.2">13.13.2</a>). <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
The scope of an <code><a href="../AA-13/AA-13.1#S0346">aspect_specification</a></code> is defined for similar reasons that it was defined for <code><a href="../AA-13/AA-13.3#S0349">attribute_definition_clause</a></code>s. <br />
</Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI12-0003-1"]} />
<Admonition type="aarm" aarm="note">
The immediate scope of a <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> is defined as it is used in other rules in the Reference Manual. <br />
</Admonition>
</AnnotatedOnly>
