...
<p>{"{"}<em>{"AI05-0150-1"}</em>{"}"} <br /><code>use_type_clause</code><a id="S0237"></a><code> ::= </code><strong>use</strong> [<strong>all</strong>] <strong>type</strong> <code><a href="../AA-3/AA-3.2#S0028">subtype_mark</a></code> {"{"}, <code><a href="../AA-3/AA-3.2#S0028">subtype_mark</a></code>{"}"};<br /></p>
...
<p>{"{"}<em>{"AI05-0131-1"}</em>{"}"} <br />Certain implicit declarations may become potentially use-visible in certain contexts as described in 12.6.<br /></p>
...
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI95-00217-06"}</em>{"}"} <br />Limited views of packages are not allowed in use clauses. Defined <em>named in a use clause</em> for use in other limited view rules (see 10.1.2). <br /></Admonition>
