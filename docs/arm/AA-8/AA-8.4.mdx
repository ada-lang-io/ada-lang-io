...
<CodeBlock>
<code>use_type_clause</code><a id="S0237"></a><code> ::= </code><strong>use</strong> [<strong>all</strong>] <strong>type</strong> <code><a href="../AA-3/AA-3.2#S0028">subtype_mark</a></code> {"{"}, <code><a href="../AA-3/AA-3.2#S0028">subtype_mark</a></code>{"}"};<br />
...
<p>A <em>package_</em><code><a href="../AA-4/AA-4.1#S0091">name</a></code> of a <code><a href="../AA-8/AA-8.4#S0236">use_package_clause</a></code> shall denote a nonlimited view of a package. <br /></p>
...
<strong></strong>The exception echoes the similar exception for &ldquo;immediate scope (of a declaration)&rdquo; (see <a href="../AA-8/AA-8.2">8.2</a>). It makes <code><a href="../AA-8/AA-8.4#S0235">use_clause</a></code>s work like this: <br /></Admonition>
...
<Admonition type="aarm" aarm="note" title="Note: ">
The declaration of Y is illegal because the scope of the &ldquo;<strong>use</strong> P&rdquo; does not include that place, so T is not directly visible there. The declarations of X, Z, and W are legal. <br /></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<strong></strong>In &ldquo;<strong>use</strong> X, Y;&rdquo;, Y cannot refer to something made visible by the &ldquo;<strong>use</strong>&rdquo; of X. Thus, it's not (quite) equivalent to &ldquo;<strong>use</strong> X; <strong>use</strong> Y;&rdquo;.<br /></Admonition>
...
<Admonition type="aarm" aarm="note" title="Note: ">
The phrase &ldquo;omitting from this set any packages that enclose this place&rdquo; is no longer necessary to avoid making something visible outside its scope, because we explicitly state that the declaration has to be visible in order to be potentially use-visible. <br /></Admonition>
...
<MarginInfo items={["AI95-00217-06"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
Limited views of packages are not allowed in use clauses. Defined <em>named in a use clause</em> for use in other limited view rules (see <a href="../AA-10/AA-10.1#Subclause_10.1.2">10.1.2</a>). <br /></Admonition>
...
<MarginInfo items={["AI05-0150-1"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
The <strong>use all type</strong> version of the <code><a href="../AA-8/AA-8.4#S0237">use_type_clause</a></code> is new to Ada 2012. It works similarly to prefixed views. <br /></Admonition>
...
<strong></strong> Added wording to allow other declarations to be potentially use-visible, to support corrections to formal subprograms. <br /></Admonition>
