...
<p><strong></strong>This includes formal packages. </p></Admonition>
...
<p><strong></strong>The exception echoes the similar exception for "immediate scope (of a declaration)" (see 8.2). It makes <code><a href="../AA-8/AA-8.4#S0235">use_clause</a></code>s work like this: </p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>In "<strong>use</strong> X, Y;", Y cannot refer to something made visible by the "<strong>use</strong>" of X. Thus, it's not (quite) equivalent to "<strong>use</strong> X; <strong>use</strong> Y;".</p></Admonition>
...
<p>{"{"}<em>{"AI05-0131-1"}</em>{"}"} <strong></strong> Added wording to allow other declarations to be potentially use-visible, to support corrections to formal subprograms. </p></Admonition>
