...
<p><strong></strong>This is so that the <code><a href="../AA-3/AA-3.8#S0070">component_declaration</a></code>s can be directly visible in the <code><a href="../AA-13/AA-13.5#S0352">record_representation_clause</a></code>. </p></Admonition>
...
<p><strong></strong>A declarative region does not include <code><a href="../AA-10/AA-10.1#S0292">context_clause</a></code>s. </p></Admonition>
...
<p><strong></strong>Don't confuse the declarative region of a declaration with the declarative region in which it immediately occurs. </p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>"Occurs immediately within" and "local to" are synonyms (when referring to declarations).</p></Admonition>
