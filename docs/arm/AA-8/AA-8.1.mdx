...
<MarginInfo items={["AI12-0094-1"]} /><li>{"{"}<em>{"AI12-0094-1"}</em>{"}"} <br />an <code><a href="../AA-3/AA-3.10#S0084">access_definition</a></code>;<br /></li>
<MarginText>2.2/5</MarginText>
<MarginInfo items={["AI12-0061-1"]} /><li>{"{"}<em>{"AI12-0061-1"}</em>{"}"} <br />an <code><a href="../AA-4/AA-4.3#S0119">iterated_component_association</a></code>;<br /></li>
<MarginText>2.3/5</MarginText>
<MarginInfo items={["AI12-0308-1"]} /><li>{"{"}<em>{"AI12-0308-1"}</em>{"}"} <br />an <code><a href="../AA-4/AA-4.3#S0131">iterated_element_association</a></code>;<br /></li>
<MarginText>2.4/5</MarginText>
<MarginInfo items={["AI05-0255-1", "AI12-0308-1"]} /><li>{"{"}<em>{"AI05-0255-1"}</em>{"}"} {"{"}<em>{"AI12-0308-1"}</em>{"}"} <br />a <code><a href="../AA-4/AA-4.5#S0153">quantified_expression</a></code>;<br /></li>
<MarginText>2.5/5</MarginText>
<MarginInfo items={["AI12-0236-1"]} /><li>{"{"}<em>{"AI12-0236-1"}</em>{"}"} <br />a <code><a href="../AA-4/AA-4.5#S0156">declare_expression</a></code>;<br /></li>
...
<MarginInfo items={["AI05-0255-1", "AI12-0308-1"]} /><li><em>This paragraph was deleted.</em>{"{"}<em>{"AI05-0255-1"}</em>{"}"} {"{"}<em>{"AI12-0308-1"}</em>{"}"}  <br /></li>
<MarginText>4.2/3</MarginText>
<MarginInfo items={["AI95-00318-02"]} /><li>{"{"}<em>{"AI95-00318-02"}</em>{"}"} <br />an <code><a href="../AA-6/AA-6.5#S0225">extended_return_statement</a></code>;<br /></li>
...
<MarginInfo items={["AI12-0094-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
...
<MarginInfo items={["AI12-0061-1", "AI12-0236-1", "AI12-0308-1"]} /><Admonition type="aarm" aarm="note" title="Note: ">
