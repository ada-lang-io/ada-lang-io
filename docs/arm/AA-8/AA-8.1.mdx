...
<MarginInfo items={["AI95-00318-02"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
<code><a href="../AA-6/AA-6.5#S0225">Extended_return_statement</a></code> (see <a href="../AA-6/AA-6.5">6.5</a>) is added to the list of constructs that have a declarative region. <br /></Admonition>
...
<MarginInfo items={["AI12-0094-1"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
<strong>Corrigendum:</strong> <code><a href="../AA-3/AA-3.10#S0084">access_definition</a></code> is added to the list of constructs that have a declarative region. This allows parameter names declared in anonymous access type subprogram types to be the same as other names declared outside. For instance: <br /></Admonition>
...
<Admonition type="aarm" aarm="note" title="Note: ">
Added <code><a href="../AA-4/AA-4.3#S0119">iterated_component_association</a></code>, <code><a href="../AA-4/AA-4.3#S0131">iterated_element_association</a></code>, and <code><a href="../AA-4/AA-4.5#S0156">declare_expression</a></code> to the rapidly expanding list of constructs that have a declarative region. <br /></Admonition>
