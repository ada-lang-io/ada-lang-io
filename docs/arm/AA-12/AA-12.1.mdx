...
<p>{"{"}<em>{"AI05-0183-1"}</em>{"}"} <br /><code>generic_subprogram_declaration</code><a id="S0311"></a><code> ::= </code><br />     <code><a href="../AA-12/AA-12.1#S0313">generic_formal_part</a></code>  <code><a href="../AA-6/AA-6.1#S0196">subprogram_specification</a></code><br />        [<code><a href="../AA-13/AA-13.1#S0346">aspect_specification</a></code>];<br /></p>
