...
<CodeBlock>
<code>generic{"_"}formal{"_"}part</code><a id="S0313"></a><code> ::= </code><br />    <strong>generic</strong> {"{"}<code><a href="/docs/arm/AA-12/AA-12.1#S0314">generic_formal_parameter_declaration</a></code> | <code><a href="/docs/arm/AA-8/AA-8.4#S0235">use_clause</a></code>{"}"}<br />
...
<strong></strong>The reason for forbidding <code><a href="/docs/arm/AA-3/AA-3.2#S0029">constraint</a></code>s in <code><a href="/docs/arm/AA-3/AA-3.2#S0027">subtype_indication</a></code>s is that it simplifies the elaboration of <code><a href="/docs/arm/AA-12/AA-12.1#S0310">generic_declaration</a></code>s (since there is nothing to evaluate), and that it simplifies the matching rules, and makes them more checkable at compile time. <br />
</Admonition>
</AnnotatedOnly>
...
<p>An entity is a <em>generic formal</em> entity if it is declared by a <code><a href="/docs/arm/AA-12/AA-12.1#S0314">generic_formal_parameter_declaration</a></code>. &ldquo;Generic formal&rdquo;, or simply &ldquo;formal&rdquo;, is used as a prefix in referring to objects, subtypes (and types), functions, procedures and packages, that are generic formal entities, as well as to their respective declarations. [Examples: &ldquo;generic formal procedure&rdquo; or a &ldquo;formal integer type declaration&rdquo;.]<br /></p>

<MarginText>9.1/5</MarginText>
<MarginInfo items={["AI12-0371-1"]} />
<p>The list of <code><a href="/docs/arm/AA-12/AA-12.1#S0314">generic_formal_parameter_declaration</a></code>s of a <code><a href="/docs/arm/AA-12/AA-12.1#S0313">generic_formal_part</a></code> form a <em>declaration list</em> of the generic unit.<br /></p>

<AnnotatedOnly>
<MarginText>9.a/5</MarginText>
<Admonition type="aarm" aarm="ramification">
<strong></strong>Aspect specifications (see <a href="/docs/arm/AA-13/AA-13.1#Subclause_13.1.1">13.1.1</a>) given in a generic formal part can only use declarations given in the formal part, and not those in the visible part of the generic unit. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
NOTE 2   Within a generic <code><a href="/docs/arm/AA-6/AA-6.3#S0216">subprogram_body</a></code>, the name of this program unit acts as the name of a subprogram. Hence this name can be overloaded, and it can appear in a recursive call of the current instance. For the same reason, this name cannot appear after the reserved word <strong>new</strong> in a (recursive) <code><a href="/docs/arm/AA-12/AA-12.3#S0315">generic_instantiation</a></code>.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
The syntax rule for <code><a href="/docs/arm/AA-12/AA-12.1#S0314">generic_formal_parameter_declaration</a></code> is modified to allow the reserved words <strong>tagged</strong> and <strong>abstract</strong>, to allow formal derived types, and to allow formal packages.<br />
</Admonition>
</AnnotatedOnly>
