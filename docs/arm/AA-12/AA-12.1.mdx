...
<p><code>generic_declaration</code><a id="S0310"></a><code> ::= </code><code><a href="../AA-12/AA-12.1#S0311">generic_subprogram_declaration</a></code> | <code><a href="../AA-12/AA-12.1#S0312">generic_package_declaration</a></code><br /></p>

<p>{"{"}<em>{"AI05-0183-1"}</em>{"}"} <code>generic_subprogram_declaration</code><a id="S0311"></a><code> ::= </code><br />     <code><a href="../AA-12/AA-12.1#S0313">generic_formal_part</a></code>  <code><a href="../AA-6/AA-6.1#S0196">subprogram_specification</a></code><br />        [<code><a href="../AA-13/AA-13.1#S0346">aspect_specification</a></code>];<br /></p>

<p><code>generic_package_declaration</code><a id="S0312"></a><code> ::= </code><br />     <code><a href="../AA-12/AA-12.1#S0313">generic_formal_part</a></code>  <code><a href="../AA-7/AA-7.1#S0230">package_specification</a></code>;<br /></p>

<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<strong></strong>{"{"}<em>{"AI05-0183-1"}</em>{"}"} No syntax change is needed here to allow an <code><a href="../AA-13/AA-13.1#S0346">aspect_specification</a></code>; a generic package can have an <code><a href="../AA-13/AA-13.1#S0346">aspect_specification</a></code> because a <code><a href="../AA-7/AA-7.1#S0230">package_specification</a></code> allows an <code><a href="../AA-13/AA-13.1#S0346">aspect_specification</a></code>. <br /></Admonition>

<p><code>generic_formal_part</code><a id="S0313"></a><code> ::= </code><strong>generic</strong> {"{"}<code><a href="../AA-12/AA-12.1#S0314">generic_formal_parameter_declaration</a></code> | <code><a href="../AA-8/AA-8.4#S0235">use_clause</a></code>{"}"}<br /></p>

<p><code>generic_formal_parameter_declaration</code><a id="S0314"></a><code> ::= </code><br />      <code><a href="../AA-12/AA-12.4#S0319">formal_object_declaration</a></code><br />    | <code><a href="../AA-12/AA-12.5#S0320">formal_type_declaration</a></code><br />    | <code><a href="../AA-12/AA-12.6#S0335">formal_subprogram_declaration</a></code><br />    | <code><a href="../AA-12/AA-12.7#S0340">formal_package_declaration</a></code><br /></p>
...
<p>{"{"}<em>{"AI95-00434-01"}</em>{"}"} A <code><a href="../AA-12/AA-12.1#S0310">generic_declaration</a></code> declares a generic unit - a generic package, generic procedure, or generic function, as appropriate.<br /></p>
...
<p>{"{"}<em>{"AI12-0371-1"}</em>{"}"} The list of <code><a href="../AA-12/AA-12.1#S0314">generic_formal_parameter_declaration</a></code>s of a <code><a href="../AA-12/AA-12.1#S0313">generic_formal_part</a></code> form a <em>declaration list</em> of the generic unit.<br /></p>
...
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI05-0183-1"}</em>{"}"} An optional <code><a href="../AA-13/AA-13.1#S0346">aspect_specification</a></code> can be used in a <code><a href="../AA-12/AA-12.1#S0311">generic_subprogram_declaration</a></code> (as well as a <code><a href="../AA-12/AA-12.1#S0312">generic_package_declaration</a></code>). This is described in 13.1.1. <br /></Admonition>


#### Wording Changes from Ada 2012

<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI12-0371-1"}</em>{"}"} Defined a formal part as a declaration list, so that the visibility of entities in aspect specifications is properly defined. <br /></Admonition>
