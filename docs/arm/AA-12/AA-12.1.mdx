...
<p>{"{"}<em>{"AI95-00434-01"}</em>{"}"} <br />A <code><a href="../AA-12/AA-12.1#S0310">generic_declaration</a></code> declares a generic unit &mdash; a generic package, generic procedure, or generic function, as appropriate.<br /></p>
