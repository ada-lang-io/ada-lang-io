...
<p><strong></strong>The reason for forbidding <code><a href="../AA-3/AA-3.2#S0029">constraint</a></code>s in <code><a href="../AA-3/AA-3.2#S0027">subtype_indication</a></code>s is that it simplifies the elaboration of <code><a href="../AA-12/AA-12.1#S0310">generic_declaration</a></code>s (since there is nothing to evaluate), and that it simplifies the matching rules, and makes them more checkable at compile time. </p></Admonition>
...
<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>Aspect specifications (see 13.1.1) given in a generic formal part can only use declarations given in the formal part, and not those in the visible part of the generic unit. </p></Admonition>
