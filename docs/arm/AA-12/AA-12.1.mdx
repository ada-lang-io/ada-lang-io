...
<MarginInfo items={["AI05-0183-1"]} /><Admonition type="aarm" aarm="ramification" title="Ramification: ">
...
<MarginInfo items={["AI95-00434-01"]} /><p>{"{"}<em>{"AI95-00434-01"}</em>{"}"} <br />A <code><a href="../AA-12/AA-12.1#S0310">generic_declaration</a></code> declares a generic unit &mdash; a generic package, generic procedure, or generic function, as appropriate.<br /></p>
...
<MarginInfo items={["AI12-0371-1"]} /><p>{"{"}<em>{"AI12-0371-1"}</em>{"}"} <br />The list of <code><a href="../AA-12/AA-12.1#S0314">generic_formal_parameter_declaration</a></code>s of a <code><a href="../AA-12/AA-12.1#S0313">generic_formal_part</a></code> form a <em>declaration list</em> of the generic unit.<br /></p>
