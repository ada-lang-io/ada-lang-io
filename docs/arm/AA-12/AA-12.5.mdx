...
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>8652/0037</em>{"}"} {"{"}<em>{"AI95-00043-01"}</em>{"}"} {"{"}<em>{"AI95-00233-01"}</em>{"}"} <br />Corrigendum 1 corrected the wording to properly define the location where operators are defined for formal array types. The wording here was inconsistent with that in <a href="../AA-7/AA-7.3#Subclause_7.3.1">7.3.1</a>, "<a href="../AA-7/AA-7.3#Subclause_7.3.1">Private Operations</a>". For the Amendment, this wording was corrected again, because it didn't reflect the Corrigendum 1 revisions in <a href="../AA-7/AA-7.3#Subclause_7.3.1">7.3.1</a>.<br /></Admonition>
...
<Admonition type="aarm" aarm="note" title="Note: ">
{"{"}<em>{"AI95-00251-01"}</em>{"}"} <br />Formal interface types are defined; see <a href="../AA-12/AA-12.5#Subclause_12.5.5">12.5.5</a>, "<a href="../AA-12/AA-12.5#Subclause_12.5.5">Formal Interface Types</a>".<br /></Admonition>
