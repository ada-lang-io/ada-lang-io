...
<p>For an <code><a href="../AA-4/AA-4.8#S0164">allocator</a></code> with a <code><a href="../AA-3/AA-3.2#S0027">subtype_indication</a></code>, the <code><a href="../AA-3/AA-3.2#S0027">subtype_indication</a></code> shall not specify a <code><a href="../AA-3/AA-3.10#S0083">null_exclusion</a></code>.<br /></p>
...
Expr_Ptr'(new Literal)                  -- allocator for access-to-class-wide type, see <a href="../AA-3/AA-3.9#Subclause_3.9.1">3.9.1</a>{"\n"}Expr_Ptr'(new Literal'(Expression with 3.5))      -- initialized explicitly{"\n"}
