...
<p><strong>Ramification: </strong>We also use terms like "generic function body" and "nongeneric package body". </p>
...
<p>NOTE 1   The syntax of generic subprograms implies that a generic subprogram body is always the completion of a declaration. </p>
