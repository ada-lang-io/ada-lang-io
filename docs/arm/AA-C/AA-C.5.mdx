...
<p><strong></strong>The semantics of some attributes and functions of an entity for which aspect Discard_Names is True.</p></Admonition>

<Admonition type="aarm" aarm="ramification" title="Ramification: ">
<p><strong></strong>The Width attribute is still defined in terms of Image.</p></Admonition>
