...
<p><em>Paragraphs 1 through 6 were moved to <a href="../AA-J/">Annex J</a>, "<a href="../AA-J/">Obsolescent Features</a>".</em> <br /></p>
...
<p>{"{"}<em>{"AI05-0229-1"}</em>{"}"} <br />If the Interrupt_Handler aspect of a protected procedure is True, then the procedure may be attached dynamically, as a handler, to interrupts (see <a href="../AA-C/AA-C.3#Subclause_C.3.2">C.3.2</a>). [Such procedures are allowed to be attached to multiple interrupts.]<br /></p>
