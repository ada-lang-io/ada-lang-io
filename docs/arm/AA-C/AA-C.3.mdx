...
<MarginInfo items={["AI12-0453-1"]} />
<Admonition type="aarm" aarm="note">
One way to approach this problem is to assign sub-ranges within Interrupt_Id to each interrupt subsystem, such that &ldquo;similar&rdquo; interrupt sources (for example a timer) in different subsystems get a distinct id. <br /></Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
NOTE   The package Interrupts.Names contains implementation-defined names (and constant values) for the interrupts that are supported by the implementation.<br /></Admonition>
</AnnotatedOnly>
