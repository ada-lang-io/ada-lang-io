...
<strong></strong>This cuts out <code><a href="/docs/arm/AA-4/AA-4.1#S0100">attribute_reference</a></code>s that are not static, except for Access and Address. <br />
</Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI12-0368-1"]} />
<Admonition type="aarm" aarm="ramification">
<strong></strong>This cuts out <code><a href="/docs/arm/AA-6/AA-6.4#S0218">function_call</a></code>s and <code><a href="/docs/arm/AA-4/AA-4.6#S0162">type_conversion</a></code>s that are not static, including calls on attribute functions like 'Image and 'Value. We do allow components if those components don't require any evaluation or checks. <br />
</Admonition>
</AnnotatedOnly>
