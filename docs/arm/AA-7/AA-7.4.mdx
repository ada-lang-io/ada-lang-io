...
<strong></strong>The first sentence is redundant, as it is stated officially in <a href="../AA-3/AA-3.3#Subclause_3.3.1">3.3.1</a>.<br />
</Admonition>
</AnnotatedOnly>
...
The first part of the last sentence is redundant, as no imported entity may have a completion, as stated in <a href="../AA-B/AA-B.1">B.1</a>. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>On the other hand, the full constant can be aliased even if the deferred constant is not. <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>On the other hand, the full constant can exclude null even if the deferred constant does not. But that can only happen for a <code><a href="../AA-3/AA-3.2#S0027">subtype_indication</a></code>, as anonymous access types are required to statically match (which includes any <code><a href="../AA-3/AA-3.10#S0083">null_exclusion</a></code>). <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
NOTE   The full constant declaration for a deferred constant that is of a given private type or private extension is not allowed before the corresponding <code><a href="../AA-3/AA-3.2#S0024">full_type_declaration</a></code>. This is a consequence of the freezing rules for types (see <a href="../AA-13/AA-13.14">13.14</a>). <br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="ramification">
<strong></strong>Multiple or single declarations are allowed for the deferred and the full declarations, provided that the equivalent single declarations would be allowed.<br />
</Admonition>
</AnnotatedOnly>
...
Null{"_"}Key : constant Key;      -- see <a href="../AA-7/AA-7.3#Subclause_7.3.1">7.3.1</a>{"\n"}
...
<Admonition type="aarm" aarm="note">
In Ada 83, a deferred constant declaration was not permitted to include a constraint, nor the reserved word <strong>aliased</strong>.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
A deferred constant declaration can be completed with a <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Import. Such a deferred constant declaration need not be within a <code><a href="../AA-7/AA-7.1#S0230">package_specification</a></code>.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
Since deferred constants can now be of a nonprivate type, we have made this a stand-alone subclause, rather than a subclause of <a href="../AA-7/AA-7.3">7.3</a>, &ldquo;<a href="../AA-7/AA-7.3">Private Types and Private Extensions</a>&rdquo;.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
Deferred constant declarations used to have their own syntax, but now they are simply a special case of <code><a href="../AA-3/AA-3.3#S0032">object_declaration</a></code>s. <br />
</Admonition>
</AnnotatedOnly>
...
<strong></strong> Corrected rules so that the intent that a full constant may have a null exclusion even if the deferred constant does not is actually met. <br />
</Admonition>
</AnnotatedOnly>
