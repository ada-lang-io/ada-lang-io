...
<MarginInfo items={["AI95-00318-02"]} />
<Admonition type="aarm" aarm="note" title="Note: ">
The fact that the full view of File_Name is explicitly declared <strong>limited</strong> means that parameter passing will always be by reference and function results will always be built directly in the result object (see <a href="../AA-6/AA-6.2">6.2</a> and <a href="../AA-6/AA-6.5">6.5</a>).<br /></Admonition>
