...
<p><strong></strong>This definition of visible part does not apply to generic formal packages - 12.7 defines the visible part of a generic formal package.</p></Admonition>
