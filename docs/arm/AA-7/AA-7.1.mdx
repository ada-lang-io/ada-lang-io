...
<strong>To be honest: </strong>If an implementation supports it, the body of a package or generic package may be imported (using aspect Import, see <a href="../AA-B/AA-B.1">B.1</a>), in which case no explicit body is allowed. <br /></Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
We have moved the syntax into this subclause and the next subclause from RM83-7.1, &ldquo;Package Structure&rdquo;, which we have removed.<br /></Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="note">
Defined &ldquo;declaration list&rdquo; to avoid ambiguity in other rules as to whether packages are included. <br /></Admonition>
</AnnotatedOnly>
...
<MarginInfo items={["AI05-0183-1"]} />
<Admonition type="aarm" aarm="note">
An optional <code><a href="../AA-13/AA-13.1#S0346">aspect_specification</a></code> can be used in a <code><a href="../AA-7/AA-7.1#S0230">package_specification</a></code>. This is described in <a href="../AA-13/AA-13.1#Subclause_13.1.1">13.1.1</a>. <br /></Admonition>
</AnnotatedOnly>
