...
<strong></strong>This follows from the general reentrancy requirements stated near the beginning of <a href="/docs/arm/AA-A/">Annex A</a>, &ldquo;<a href="/docs/arm/AA-A/">Predefined Language Environment</a>&rdquo;. <br />
</Admonition>
</AnnotatedOnly>
...
<p>If the locking policy Ceiling{"_"}Locking (see <a href="/docs/arm/AA-D/AA-D.3">D.3</a>) is in effect, then the ceiling priority of a protected object <em>P</em> is set to the value of <em>P</em>'Priority at the end of each protected action of <em>P</em>.<br /></p>
