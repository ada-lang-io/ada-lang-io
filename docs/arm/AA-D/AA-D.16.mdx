...
<MarginInfo items={["AI12-0048-1"]} />
<Admonition type="aarm" aarm="note">
<strong>To be honest: </strong>&ldquo;Ready queue&rdquo; here doesn't mean the conceptual "ready queue" as defined in <a href="/docs/arm/AA-D/AA-D.2#Subclause_D.2.1">D.2.1</a> (one per processor); this rule is talking about the ready queues used by the implementation. <br />
</Admonition>
</AnnotatedOnly>
