...
<p><i>Paragraphs 2 and 3 were moved to <a href="/docs/arm/AA-13/AA-13.12">13.12</a>, &ldquo;<a href="/docs/arm/AA-13/AA-13.12">Pragma Restrictions and Pragma Profile</a>&rdquo;.</i> <br /></p>
...
<p>The <i>profile{"_"}</i><code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code> Ravenscar and <i>profile{"_"}</i><code><a href="/docs/arm/AA-2/AA-2.3#S0002">identifier</a></code> Jorvik are usage profiles (see <a href="/docs/arm/AA-13/AA-13.12">13.12</a>). For usage profiles Ravenscar and Jorvik, there shall be no <i>profile{"_"}</i><code><a href="/docs/arm/AA-2/AA-2.8#S0020">pragma{"_"}argument{"_"}association</a></code>s. <br /></p>
...
<b></b>The Ravenscar profile is named for the location of the meeting that defined its initial version. The name is now in widespread use, so we stick with existing practice, rather than using a more descriptive name.<br />
</Admonition>
</AnnotatedOnly>
...
<Admonition type="aarm" aarm="discussion">
<b></b>The Jorvik profile removes a number of restrictions from the Ravenscar profile to allow additional applications to benefit from predictability and low overhead. Specifically, the following restrictions are removed: <br />
</Admonition>
</AnnotatedOnly>
...
<p><i>Paragraph 7 and 8 were deleted.</i> <br /></p>
...
<b></b>On a multiprocessor system, each processor should have a separate and disjoint ready queue.<br />
</Admonition>
</AnnotatedOnly>
