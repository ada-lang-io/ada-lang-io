...
<p>The <em>profile{"_"}</em><code><a href="../AA-2/AA-2.3#S0002">identifier</a></code> Ravenscar and <em>profile{"_"}</em><code><a href="../AA-2/AA-2.3#S0002">identifier</a></code> Jorvik are usage profiles (see <a href="../AA-13/AA-13.12">13.12</a>). For usage profiles Ravenscar and Jorvik, there shall be no <em>profile{"_"}</em><code><a href="../AA-2/AA-2.8#S0020">pragma{"_"}argument{"_"}association</a></code>s. <br /></p>
