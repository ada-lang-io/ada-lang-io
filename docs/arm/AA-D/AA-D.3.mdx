...
<p class="Indented2">The form of a <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Locking_Policy is as follows: <br /></p>

<MarginText>3</MarginText>
<p class="Indented2">  <strong>pragma</strong> Locking_Policy(<em>policy_</em><code><a href="../AA-2/AA-2.3#S0002">identifier</a></code>); <br /></p>
