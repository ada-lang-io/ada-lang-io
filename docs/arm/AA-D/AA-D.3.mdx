...
<p><strong></strong>Implementation-defined <em>policy_</em><code><a href="../AA-2/AA-2.3#S0002">identifier</a></code>s allowed in a <code><a href="../AA-2/AA-2.8#S0019">pragma</a></code> Locking_Policy.</p></Admonition>
...
<Admonition type="aarm" aarm="implementation-defined" title="Implementation defined: ">
<p><strong></strong>The locking policy if no Locking_Policy pragma applies to any unit of a partition.</p></Admonition>
...
<Admonition type="aarm" aarm="implementation-defined" title="Implementation defined: ">
<p><strong></strong>Default ceiling priorities.</p></Admonition>
...
<Admonition type="aarm" aarm="implementation-defined" title="Implementation defined: ">
<p><strong></strong>The ceiling of any protected object used internally by the implementation.</p></Admonition>
...
<p><strong></strong>Names that end with "_Locking" should be used for implementation-defined locking policies.</p></Admonition>
