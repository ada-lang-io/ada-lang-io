...
<p>{"{"}<em>{"AI05-0299-1"}</em>{"}"} <br />[This subclause defines restrictions that can be used with a pragma Restrictions (see <a href="../AA-13/AA-13.12">13.12</a>) to facilitate the construction of highly efficient tasking run-time systems.] <br /></p>
