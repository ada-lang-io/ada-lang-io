...
<strong></strong>This includes specifying via pragmas (see <a href="/docs/arm/AA-J/AA-J.15#Subclause_J.15.11">J.15.11</a>). Note that <a href="/docs/arm/AA-13/AA-13.1">13.1</a> prevents multiple specifications of a single representation aspect by any means. <br />
</Admonition>
</AnnotatedOnly>
...
<strong></strong>Other parts of the annex, e.g. <a href="/docs/arm/AA-D/AA-D.11">D.11</a>, define other sources of priority inheritance. <br />
</Admonition>
</AnnotatedOnly>
...
<ul>
<li>{"{"}<em>8652/0072</em>{"}"} During activation, a task being activated inherits the active priority that its activator (see <a href="/docs/arm/AA-9/AA-9.2">9.2</a>) had at the time the activation was initiated.<br /></li>
<MarginText>22/1</MarginText>
<MarginInfo items={["AI95-00092-01"]} />
<li>{"{"}<em>8652/0072</em>{"}"} During rendezvous, the task accepting the entry call inherits the priority of the entry call (see <a href="/docs/arm/AA-9/AA-9.5#Subclause_9.5.3">9.5.3</a> and <a href="/docs/arm/AA-D/AA-D.4">D.4</a>).<br /></li>
...
<MarginInfo items={["AI05-0229-1"]} />
<Admonition type="aarm" aarm="ramification">
<strong></strong>The use of a Priority or Interrupt{"_"}Priority aspect does not require the package System to be named in a <code><a href="/docs/arm/AA-10/AA-10.1#S0294">with_clause</a></code> for the enclosing <code><a href="/docs/arm/AA-10/AA-10.1#S0286">compilation_unit</a></code>. <br />
</Admonition>
</AnnotatedOnly>
