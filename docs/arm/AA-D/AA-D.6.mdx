...
<p><strong></strong>The <code><a href="../AA-9/AA-9.8#S0284">abort_statement</a></code> should not require the task executing the statement to block.</p></Admonition>
...
<Admonition type="aarm" aarm="implementation-advice" title="Implementation Advice">
<p><strong></strong>On a multi-processor, the delay associated with aborting a task on another processor should be bounded.</p></Admonition>
