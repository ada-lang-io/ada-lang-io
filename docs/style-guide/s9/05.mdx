...
In this second example, the type Basic_Window responds to various events
and calls:
...
inheriting a Balance state twice for NOW_Account.Object. To resolve this
ambiguity, you need to use an abstract type hierarchy for the multiple
inheritance of interface and separate mixins for the multiple
