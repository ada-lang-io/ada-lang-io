...
- Anticipate the range of values of subexpressions to avoid exceeding
  ...
  factoring, and range constraints on numeric types (see Guidelines
...
Reference Manual, §3.5.9](../../arm/AA-3/AA-3.5.mdx#Subclause_3.5.9)). The
Information Systems Annex provides additional support for decimal types.
It requires a minimum of 18 significant digits. It also specifies a
Text_IO.Editing package that provides support analogous to the COBOL
picture approach.
...
§3.10.2](../../arm/AA-3/AA-3.10.mdx#Subclause_3.10.2) explains that an
...
the subprogram." The [Ada Reference Manual,
§4.5.2](../../arm/AA-4/AA-4.5.mdx#Subclause_4.5.2) states that it is
"unspecified whether two access values that designate the same
...
§13.11.2](../../arm/AA-13/AA-13.11.mdx#Subclause_13.11.2).
