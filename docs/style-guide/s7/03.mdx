...
[Ada Reference Manual, §9.2](../../arm/AA-9/AA-9.2.mdx). See also Guideline
6.1.5.
...
- Do not assume a correlation between System.Tick and type Duration (see
  Guidelines 6.1.7 and 7.4.2).
