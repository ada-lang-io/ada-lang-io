...
The [Ada Reference Manual, §A.7](../../arm/AA-A/AA-A.7.mdx) does not define
what happens to external files after completion of the main subprogram
...
The [Ada Reference Manual, §A.7](../../arm/AA-A/AA-A.7.mdx) does not
specify the effects of I/O on access types. When such a value is
written, it is placed out of reach of the implementation. Thus, it is
out of reach of the reliability-enhancing controls of strong type
checking.
...
Stream_IO should be reserved for processing heterogeneous files. In this
case, a file is not a sequence of objects of all the same type but
