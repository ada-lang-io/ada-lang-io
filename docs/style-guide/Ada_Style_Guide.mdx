...
This [style guide](https://en.wikipedia.org/wiki/Programming_style) is
an update to the _[Ada 95 Quality and Style
Guide](http://www.adaic.org/docs/95style/html/cover.html)_ to reflect
the latest update to the [Ada
language](<https://en.wikipedia.org/wiki/Ada_(programming_language)>),
commonly called [Ada
2012](https://en.wikibooks.org/wiki/Ada_Programming/Ada_2012). The
...
not intended to replace the _[Ada Reference
...
language](https://en.wikibooks.org/wiki/Ada_Programming).
...
95](https://en.wikibooks.org/wiki/Ada_Programming/Ada_95) with
modifications to the original _[Ada Quality and Style: Guidelines for
Professional
...
developed to support [Ada
83](https://en.wikibooks.org/wiki/Ada_Programming/Ada_83). The Ada 95
guidelines are based on the wealth of data available from the Ada 9X
...
update and the [Advanced Research Projects
Agency](https://en.wikipedia.org/wiki/Advanced_Research_Projects_Agency)
(ARPA) participated in the update effort.
...
[wikibooks](https://en.wikibooks.org/wiki/Main_Page) to encourage
...
the Ada 83 and 95 style guides.
