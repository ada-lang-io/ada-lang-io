...
data and can limit or restrict the operations performed on that data.<i>
...
subsequently maintained"</i>
(Pyle 1985 ). Take advantage of Ada's strong typing capability in the form of subtypes, derived
...
case of a self-referential data structure (see Guideline 5.4.6 ), you
need the access parameter to be able to manipulate the data the
discriminant accesses (Rationale 1995, §3.7.1 ).
...
types ([Ada Reference Manual,
§3.10.2](../../arm/AA-3/AA-3.10.mdx#Subclause_3.10.2)).
